        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MORONG BEACH</span></h2>

                    </div>
                    <div class="description">
                        Morong Beach in Sabtang Island, Batanes features only a short stretch of sand that is surrounded by low grass-covered hills on all sides. The pristine white sand here is like Boracay's. 
                        The glass-like turquoise water in Morong Beach is calmer and friendlier than other beaches in Batanes despite the usual rough weather. The water here is peaceful enough for a swim.
                        On one area of the beach, you'll find a large rock formation that you can walk through. This rock formation is known as Nakabuang Arch. This is why the beach is also known as Nakabuang Beach.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/mor1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/mor2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/mor3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/mor4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/mor5.webp" style="width:100%">
                        </div>
