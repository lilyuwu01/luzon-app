...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN CATANDUANES</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/binurong.webp" alt="Binurong Point" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Binurong Point</p>
                    <p class="desc1">Binurong Point is one of the best tourist spots in Catanduanes, recognized as its most visited sightseeing destination. 
                        It is a highland composed of rolling green hills and steep rocky cliffs on the west coasts of the island province overlooking the Pacific Ocean.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/binurong-point"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Puraran Beach</p>
                    <p class="desc2">Puraran Beach is a famous surfing destination in Catanduanes. The beach features a wide and considerable stretch of cream-colored sand, 
                        interesting rock formations and a serene background of jungle-covered rolling hills. It is situated on eastern edge of the island facing the Pacific 
                        Ocean that’s why it has strong and big waves perfect for surfing. The “Majestic Wave” is the name of its signature surfing wave and according to locals, 
                        waves can reach up to 6 feet especially during typhoon season.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/puraran-beach"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/pura.webp" alt="Puraran Beach" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/balacay.jpg" alt="Balacay Point" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Balacay Point</p>
                    <p class="desc1">Balacay Point, commonly known as “Benticayan Point“, is one of the known tourist spots in Catanduanes. 
                        It is also a highland and a sightseeing destination just like Binurong Point composed of rolling green hills and steep 
                        cliffs though this one has higher elevation and smaller area.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/balacay-point"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Saint John the Baptist Church</p>
                    <p class="desc2">Saint John the Baptist Church, commonly referred to as “Bato Church“, is one of the historical sites in Catanduanes. 
                        It is the oldest church in the province built on 1830 and was finished on 1883, it took 53 years to complete.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/saint-john-the-baptist-church"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/saint john.webp" alt="Saint John the Baptist Church" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/patag.webp" alt="Patag Island" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Patag Island</p>
                    <p class="desc1">Patag Island, also known as “Cagraray Island“, is one of the best tourist spots in Catanduanes. The island is composed of 
                        some white sand, a clear water lagoon, rock formations and massive flat boulders at its center with some growing plants. The island is 
                        prominently composed of flat boulders on different unorganized elevations and sizes. “Patag” in local dialect means “flat“, hence the 
                        name of the island was derived. isitors can carefully climb near the rock cliffs for a panoramic view of the sea and mainland.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/patag-island"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/camarines-sur" class="previous round">&#8249;</a>
                                <a href="/masbate" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
