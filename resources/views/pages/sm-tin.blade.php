        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>TINIPAK RIVER</span></h2>

                    </div>
                    <div class="description">
                        Tinapak was logging and mining area, and in 1992 the Elders of the area, known as the Dumagats, got the government to stop the works. Since 2010 this area has been a model for exotourism, with well thought our planning, trained local guides and strict regulations for the area. It is very clear on arrival, that they know what they are doing, and they do it very well.
                        Tinipak Lake is located in Tanay, Rizal. It is a good two and a half hour drive from Manila, so you need to set of early in the monring.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/tin1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/tin2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/tin3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/tin4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/tin5.jpg" style="width:100%">
                        </div>
