        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>VERDIVIA FALLS</span></h2>

                    </div>
                    <div class="description">
                        Located in Brgy. Talbak at Doña Remedios Trinidad, Verdivia Falls is a popular ecological tourist attraction in Bulacan for picnics and outings. Verdivia was named as such for its verdant green water.
                        Verdivia falls is only one of the beautiful things Bulacan can give. It is a safe place for adventure-seekers, nature-lovers, and for everyone else. Tourists may swim, have their picnic, go jamming with their friends, relax with their family, and have fun for themselves. Surely, if you're seeking for a place of difference, Bulacan is the place to go.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ver1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ver2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ver3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ver4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ver5.jpg" style="width:100%">
                        </div>
