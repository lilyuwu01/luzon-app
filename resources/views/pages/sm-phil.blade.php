    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/marikina"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>PHILIPPINE SCIENCE CENTRUM</span></h2>

                    </div>
                    <div class="description">
                        Philippine Science Centrum (PSC), a flagship program of the Philippine Foundation for Science and Technology, is a premier hands-on science center museum in the country recognized by the Department of Education, Department of Science and Technology and the Department of Tourism. Catering for all ages, PSC is a great place for educational field trips or family and barkada bonding where visitors can learn and interact with the exhibits.
                        The first interactive science center-museum in the Philippines established in 1990, Philippine Science Centrum features over a hundred hands-on exhibits divided to ten themed galleries to promote self-discovery. Aside from the museum tour, the Philippine Science Centrum also offers training, seminars, and workshops.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/phil1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/phil2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/phil3.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/phil4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/phil5.PNG" style="width:100%">
                        </div>
