    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/bicol"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>TAMBAC BEACH</span></h2>

                    </div>
                    <div class="description">
                        Tambac Beach is the perfect place for a vacation. There is so much to do other than relaxing. From a walk on the pristine beaches, to snorkeling, to kayaking and diving at the Marine Sanctuary. Literally, you will have a dozen things to tingle your senses and fulfill your dream vacation.
                        Tambac Beach, a lesser-known coastal destination in the province with azure waters. In the morning, you’ll wake up to the sound of waves crashing to the pebbly shores and cream-colored sand. Another thing that you shouldn’t miss is the charming sunset that you can watch from the veranda of the resort like a VIP. Overall, it’s the right and perfect amount of fun and relaxing vibes that will make you come back for more.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/tam1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/tamb2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/tamb3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/tamb4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/tamb5.jpg" style="width:100%">
                        </div>
