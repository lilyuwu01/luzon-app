        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MACTOL FALLS</span></h2>

                    </div>
                    <div class="description">
                        This towering falls about 50 meters high spills into a shimmering basin about twenty-two meters deep. All who can appreciate nature in its untouched and raw form should make the trip to Mactol Falls. It is located at San Pugo, Nagtipunan.
                        Mactol falls is located at barangaySan Pugo,a remote barangay of of the 16 barangays of the municipality of Nagtipunan Quirino.From Nagtipunan you have to pass by barangay Ponggo and barangay Wasid.The road to these barangays are concrete with some parts being rehabilitated.Barangay Wasid is the jump off point to San Pugo.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/mac1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/mac2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/mac3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/mac4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/mac5.webp" style="width:100%">
                        </div>
