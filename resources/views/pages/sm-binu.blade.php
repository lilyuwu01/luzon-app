        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BINURONG POINT</span></h2>

                    </div>
                    <div class="description">
                        Binurong Point gets its name from the process of preserving food by salting and soaking in vinegar or “buro”. Locals call the place as such because they traditionally brought fish they caught to to preserve it here. Binurong” is also a Bicol word meaning “Healed”.
                        But now, thanks to social media, it’s become a popular hiking destination in the province, with tourists of all ages trekking to enjoy the view.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/binu1.png" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/binu2.png" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/binu3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/binu4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/binu5.png" style="width:100%">
                        </div>
