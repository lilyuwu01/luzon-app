    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/pasig"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>THE BIKE PLAYGROUND</span></h2>

                    </div>
                    <div class="description">
                    The Bike Playground is home to the first and only Velosolutions Pumptrack in the Philippines. Aside from the regular pump track sessions, The Bike Playground also offers bike lessons, skills coaching, trail guiding, and bike trips with Coach Bans Mendoza - a PMBIA certified bike instructor.
                    The Bike Playground is the Philippines’ first signature pump park. Here’s what you can expect when you visit the award-winning bike park.
                    In Metro Manila, life as a bike enthusiast is tough. The already dangerous roads are ridden with irresponsible drivers, not to mention air and noise pollution. Good thing there’s bike park, The Bike Playground located at Circulo Verde! The Bike Playground is the Philippines’ first signature pump park designed by Claudio Caluori, an international designer and mountain bike celebrity. Here’s what you can expect when you visit the award-winning bike park.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bike1.jpeg" style="width:100%">
                        </div>
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bike3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bike4.jfif" style="width:100%">
                        </div>
