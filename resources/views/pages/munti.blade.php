...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN MUNTINLUPA</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/ala.jfif" alt="Alabang Town Center" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Alabang Town Center</p>
                    <p class="desc1">Owned by Ayala Malls and is frequented by those from the southern part of Manila such as those from Las Piñas and Parañaque. The mall features several high-end international boutique chains such as Gap and Marks & Spencer. There’s a Rustan’s Department Store in the mall as well.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/alabang-town-center"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Jamboree Lake</p>
                    <p class="desc2">Jamboree Lake is a small recreational lake in Muntinlupa, Metro Manila, the Philippines. At 1.5 hectares (3.7 acres), it is the smallest natural lake in the country located within the 587-hectare (1,450-acre) New Bilibid Prison Reservation.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/jamboree-lake"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/jam.jpg" alt="Jamboree Lake" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/jap.jpg" alt="Japanese Memorial Cemetery" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Japanese Memorial Cemetery</p>
                    <p class="desc1">A garden cemetery dedicated to Japanese soldiers who were imprisoned and executed in Muntinlupa during the war is also located inside the New Bilibid Prison Reservation Compound. Legend has it that the infamous General Tomoyuki Yamashita, the “Tiger of Malaya” is also buried in this cemetery. Many Japanese tourists visit the place to give respect to their ancestors, hence, a Filipino-Japanese Peace Monument is also located in the area.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/japanese-memorial-cemetery"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Sunken Garden</p>
                    <p class="desc2">The Muntinlupa Sunken Garden, also known as the New Bilibid Prison Sunken Garden and often shortened to simply Sunken Garden, is a large public urban park and a local government-protected zone in Muntinlupa, southern Metro Manila, the Philippines. It is an open grassy space on the southern shore of Jamboree Lake that is lower than the surrounding elevation in the New Bilibid Prison Reservation. The park is under the joint operation and management of the City Government of Muntinlupa and the Bureau of Corrections.
                    </p>
                    <button class="b4" style="vertical-align:middle"><a href="/sunken-garden"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/sunken.jpg" alt="Sunken Garden" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/munti.jpg" alt="Philippine Science Centrum" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Museo ng Muntinlupa</p>
                    <p class="desc1">Museo ng Muntinlupa (Museo) is a cultural and educational venue of the city of Muntinlupa. It is the primary venue to present and preserve the history, heritage, and culture of the Muntinlupeños for generations to come.
                    As a city museum, Museo acquires, conserves, researches, communicates, and exhibits the tangible and intangible heritage of the city of Muntinlupa and its environment.
                    </p>
                    <button class="b5" style="vertical-align:middle"><a href="/museo-ng-muntinlupa"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/marikina" class="previous round">&#8249;</a>
                                <a href="/navotas" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
