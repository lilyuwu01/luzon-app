        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LUBO AND MANGALI RICE TERRACES</span></h2>

                    </div>
                    <div class="description">
                        The Lubo and Mangali Rice Terraces are located in Tabuk, Kalinga, Philippines. The rice terraces surround the villages of Lubo. These rice terraces are like an amphitheater along the whole mountain slopes. For the best time that you can see the terraces is during the planting season and when the rice terraces are ready for the harvest.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/lub1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/lub2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/lub3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/lub4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/lub5.jpg" style="width:100%">
                        </div>
