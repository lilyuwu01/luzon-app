        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>RANCHO DE CABILEO</span></h2>

                    </div>
                    <div class="description">
                        Rancho De Cabileo is an ecological park situated in Brgy. Cabileo, Cuyapo, Nueva Ecija. Its main attraction is the unobstructed view and immersion of the beautiful landscape of Colosboa Hills.
                        f you are looking for a romantic getaway that offers an unobstructed view of nature, then Rancho De Cabileo in Nueva Ecija, Philippines is the place for you. This ecological park is situated in Brgy. Cabileo, Cuyapo and offers stunning views of Colosboa Hills. You can also rent a boat to explore the area further or enjoy an intimate picnic lunch prepared by the staff. No matter what you choose to do, Rancho De Cabileo is sure to provide you with a truly memorable experience.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ra1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ra2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ra3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ra4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ra5.jpg" style="width:100%">
                        </div>
