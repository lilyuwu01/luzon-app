        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>GOVERNOR'S RAPIDS</span></h2>

                    </div>
                    <div class="description">
                        The tale goes back during World War II when the old province was under the administration of a Japanese governor. Road networks were not yet developed and rivers instead were used as the main thoroughfare in the valley. It has been told that the rapids claimed the life of the Japanese governor whose body was never found after the tragic accident. Since then, the river has been called Governor’s Rapids.
                        Back to present day, visiting tourist would find the river suitable for swimming, kayaking and fishing. You may hire a boat and the fisherman will gladly give you a river cruising tour.
                        Freshwater eels (igat) and other freshwater fishes grow in abundance in its clear waters providing livelihood to local fishermen. Governor’s Rapids is also ideal for whitewater rafting during rainy season.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/gov1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/gov2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/gov3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/gov4.JPG" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/gov5.webp" style="width:100%">
                        </div>
