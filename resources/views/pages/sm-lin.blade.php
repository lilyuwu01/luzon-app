        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LINTUNGAN FALLS</span></h2>

                    </div>
                    <div class="description">
                        Lintungan Falls was named Tuy-ob Falls by locals in the early years. It means drop of water. The Igorots were first inhabitants of the area. It was then changed to Lintungan Falls since the falls is located at Sitio Lintungan. Lintungan Falls discovers during hunting days when they chasing the deer and wild animals they reach the waterfalls according to the founder of this community.
                        Lintungan Falls is about 3 kms away from the highway passing through a one-way graveled road with cemented portion. Traveling time from the barangay hall is approximately 10-15 minutes using a 4-wheeled vehicle, tricycle or single motor.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/lin1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/lin2.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/lin3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/lin4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/lin5.webp" style="width:100%">
                        </div>
