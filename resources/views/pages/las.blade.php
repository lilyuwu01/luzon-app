...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN LAS PINAS</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/jos.jpg" alt="Saint Joseph Church" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Saint Joseph Church</p>
                    <p class="desc1">The church is commonly known as the Las Pinas Bamboo Organ Church, which is the Roman 
                        Catholic Church of Las Pinas. Its common name comes from the organ in site, because it is a pipe organ 
                        mostly made using bamboo tubes. The church was built around 1795 by Fray Diego de la Carmen, who was a 
                        Spanish native traveling from Mabalacat.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/saint-joseph-church"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Bamboo Organ Museum</p>
                    <p class="desc2">This museum displays artifacts and old photographs of the St Joseph Parish Church. 
                        The museum will show and explain the history of the church and how it was built, and the significant 
                        contributions that were brought about from its existence. The bamboo organ was built by a Spanish native 
                        Fray Diego de la Carmen between 1817 and 1824, whose family had been organ builders in Spain, but normally 
                        used wood.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/bamboo-organ-museum"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/bam.jpg" alt="Bamboo Organ Museum" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/sant.jpg" alt="Santuario De San Ezekiel Moreno" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Santuario De San Ezekiel Moreno</p>
                    <p class="desc1">The Santuario De San Ezekiel Moreno was built in honor of the Spanish Augustinian priest who served as priest of Las Pinas from 1876 to 1879. 
                        The church is also known to be the grandest center of faith in south Metro Manila. The church is located in Barangay Pulanglupa, along the old town Las Pinas 
                        historical corridor and has the architectural elements of the Spanish colonial period. Although this church is new compared to the St. Joseph Church, it holds 
                        a lot of significance in Las Pinas City.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/santuario-de-san-ezekiel-moreno"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">LPPCHEA</p>
                    <p class="desc2">LPPCHEA, a 175-hectare wetland off Manila Bay, will further take someone's mind off from the taxing urban grind. 
                        LPPCHEA is divided into two islands- the Long and Freedom Island, and had been declared as critical habitat on April 22, 2007 
                        by Presidential Proclamation No.1412.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/lppchea"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/last.webp" alt="LLPCHEA" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/nature.jpg" alt="Nature Church" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Nature Church</p>
                    <p class="desc1">Nature Church is a park and worship place situated on a 4000-square meter land in Las Piñas. 
                        It is formally known as the Parish of Mary Immaculate Church. Like its namesake, Nature Church offers a 
                        refreshing scenery of a thick carpet of trees and plants that green thumbs and plant parents will surely love.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/nature-church"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/national-capital-region" class="previous round">&#8249;</a>
                                <a href="/makati" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
