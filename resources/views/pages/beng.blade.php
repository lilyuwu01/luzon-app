...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN BENGUET</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/Tekip.webp" alt="tekip falls" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Tekip Falls</p>
                    <p class="desc1">Tekip Falls is one of the countless waterfalls found in Bakun. Measuring more than 120 feet high,
                        it cascades like a giant curtain of water. It has small and shallow pools with icy-cold waters. The best time to 
                        visit Tekip falls and other cascades of Bakun is during the rainy months of June to December. During these periods, 
                        the falls display their full strength and beauty. It is one of the iconic Bakun, Benguet tourist spots. </p>
                    <button class="b1" style="vertical-align:middle"><a href="/tekip-falls"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Aran Cave</p>
                    <p class="desc2">Aran Cave is rapidly gaining popularity among locals residing in Baguio City and La Trinidad. 
                        It is just more or less an hour of drive away from these urban centers. The cave is named after a giant called 
                        Aran. Locals say that he used to dwell in the area and was responsible for the disappearance of workers during 
                        the construction Kennon Road.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/aran-cave"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/aran.webp" alt="Aran Cave" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/timbak.webp" alt="Mt. Timbak" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mt. Timbak</p>
                    <p class="desc1">Mt Timbak stands prominently along the Halsema Highway. It is the third highest mountain 
                        in Luzon and the ninth highest in the Philippines. Atop the mountain, once can catch amazing views of 
                        the sunrise and occasional sea of clouds. Mt Pulag and Mt Tabayoc are also visible from here. Mt Timbak 
                        is one of the most popular Atok, Benguet tourist spots.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/mt-timbak"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Northern Blossom Flower Farm</p>
                    <p class="desc2">The Northern Blossom Flower Farm in Atok went viral in the social media lately. It is a five-hectare 
                        site that grows an amazing diversity of colorful flowers including the iconic cabbage roses. The farm sits on a high elevation, 
                        thus, it also offers a panoramic view of the mountain ranges including Mt Timbak and Mt Pulag. It is now one of the most popular 
                        Atok, Benguet tourist spots.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/northen-blossom-flower-farm"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/nothern.jpg" alt="Northern Blossom Flower Farm" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/ulap.webp" alt="Mt. Ulap" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mt. Ulap</p>
                    <p class="desc1">Mt. Ulap fares as one of the most popular hiking tourist spots in Benguet. Unlike Mt. Pulag, 
                        the trails going to Mt. Ulap’s summit are mostly lined with pine forest stands. The second and more popular 
                        trail starts from barangay Sante Fe of Itogon. Take note. Mt. Ulap is part of the ancestral domains of Itogon. 
                        The peak of Mt. Ulap provides fascinating views of Cordillera’s mountain ranges and even the southern plains 
                        dominated by Mt. Arayat.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/mt-ulap"><span> See More</span></a></button>

                    <div class="see-more">
                         <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/apayao" class="previous round">&#8249;</a>
                                <a href="/ifugao" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
