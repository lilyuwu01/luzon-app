        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>GULON PEAK</span></h2>

                    </div>
                    <div class="description">
                        Nueva Vizcaya is a hiker's dream with the number of hiking trails and mountains in the province. Gulon Peak in the municipality
                        of Amabaguio offers a hiking trail that is accessible for hikers from beginners to advanced. It is actually one of the most
                        accessible hiking destinations in the province. The starting point to the peak is at Brgy. Poblacion. Trekking through the lush 
                        forests takes 20-30 minutes overall to reach Gulon Peak. At the top, you can catch a panoramic view of the versed mountain ranges.
                        The most amazing sight will be during sunrise and if you are lucky, a sea of clouds. 
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/gul1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/gul2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/gul3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/gul4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/gul5.jpg" style="width:100%">
                        </div>
