    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/nueva-ecija"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>FARM VILLARONTE'S FLOWER FARM</span></h2>

                    </div>
                    <div class="description">
                        Farm Villaronte, or Villaronte Agri-Tourism Park, is located in Brgy. San Francisco, San Antonio, Nueva Ecija. A number of people stream in daily to snap photos of the beds of flowers and pose for the ‘gram. Sunflowers, marigolds, celosias, zinnias, and more varieties of colorful blooms can be found in this flower farm.
                        Aside from the pretty blooms, you can also find a few installations scattered around the farm to strike poses beside. There’s a yellow-painted Yamaha grand piano, a bicycle, and a number of benches and swings with witty signs.
                        The flower farm is also a hotspot for prenup and even family photoshoots. A dreamy backdrop of the yellow, orange, and red blooms under the blue sky makes for quite a romantic photo.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/fa1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/fa2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/fa3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/fa4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/fa5.jpg" style="width:100%">
                        </div>
