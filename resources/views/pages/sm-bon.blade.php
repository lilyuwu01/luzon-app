        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BONSAI FOREST</span></h2>

                    </div>
                    <div class="description">
                        Dinapigue showcases a bonsai forest with plants ranging from one foot to 7 feet in height. The forest is astonishing – covering an estimated 5,000 hectares. The bonsai forest adds luster and charm to the Northern Sierra Madre Natural Park being included in the Tentative List of the UNESCO World Heritage Site.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bon1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bon2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bon3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bon4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bon5.jpg" style="width:100%">
                        </div>
