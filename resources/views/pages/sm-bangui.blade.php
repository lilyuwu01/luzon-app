        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BANGUI WINDMILLS</span></h2>
                    ...
                    <div class="description">
                        ...
                        The Bangui Wind Farm as it is today, was completed in two phases. The Bangui Wind Farm as it is today, was completed in two phases. While the project was set in motion in 1998; phase II was actually completed in 2008, and added 5 more wind turbines. This makes the whole area surrounding the Bangui 
                        Wind Farm and Ilocos Norte, one with the lowest carbon emission footprints within the Asian developing countries.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bang1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bang2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bang3.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bang4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bang5.JPG" style="width:100%">
                        </div>
