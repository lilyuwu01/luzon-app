...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/mq.webp" alt="Museo ni Manuel Quezon" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Museo ni Manuel Quezon</p>
                    <p class="desc1">Built in 1979 and modernized in 2015, Museo ni Manuel Quezon is a mausoleum that contains the remains and memorabilia of the father of Quezon City, the First President of the Commonwealth, Manuel Luis Quezon.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/museo-ni-manuel-quezon'"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">La Mesa Ecopark</p>
                    <p class="desc2">
                    The La Mesa Park and Resort was established in the 1950s. It was opened to the public and quickly became a popular picnic destination for Metro Manila residents until the mid-1970s. However, the Park was eventually closed due to neglect. The facilities were in disrepair. 
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/la-mesa-ecopark"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/mes.jpg" alt="La Mesa Ecopark" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/mem.jpg" alt="Santo Domingo Church" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Santo Domingo Church</p>
                    <p class="desc1">Santo Domingo Church, formally known as the National Shrine of Our Lady of the Most Holy Rosary
                    Is the largest church in Metro Manila and one of the biggest churches in Asia. It is dedicated to Mary, mother of Jesus under her title Our Lady of the Most Holy Rosary.
                    </p>
                    <button class="b3" style="vertical-align:middle"><a href="/santo-domingo-church><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/pateros" class="previous round">&#8249;</a>
                                <a href="/qc" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
