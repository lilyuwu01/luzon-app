    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/mandaluyong"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>GREENFIELD WEEKEND MARKET</span></h2>

                    </div>
                    <div class="description">
                        A consistent presence in the list of top weekend markets in Metro Manila, Greenfield Weekend Market has been making waves since its launch last March 2014, attracting thousands of market goers who are looking for a different kind of Saturday. Rich with adventures on food, shopping, vintage, art, music and even fortune telling, Greenfield Weekend Market promises to showcase Metro Manila’s most unique finds and to be a unique outdoor family destination --- all nestled in a wide, green expanse in the middle of the city.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/gf1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/gf2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/gf3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/gf4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/gf5.jpg" style="width:100%">
                        </div>
