    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/ilocos-sur"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>PLAZA SALCEDO</span></h2>

                    </div>
                    <div class="description">
                        Named after the Spanish conquistador Juan de Salcedo, Plaza Salcedo is both the city’s central attraction as well as its town center. Much like any old Spanish settlement, 
                        Plaza Salcedo is surrounded by all of the places you’ll need to visit in Vigan: the town hall, regional hall, local shopping center, and the church. Now, it is also surrounded 
                        by fast food diners, making it every Vigan visitors’ go-to place. It was supposed to have 4 sunken gardens which would represent the four seasons experienced in the Western countries: 
                        Winter, Spring, Summer, and Fall. Moreover, at the middle of the park is the 17th-century monument of Juan de Salcedo, the oldest of its kind in Northern Luzon.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/pla1.JPG" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/pla2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/pla3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/pla4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/pla5.jpg" style="width:100%">
                        </div>
