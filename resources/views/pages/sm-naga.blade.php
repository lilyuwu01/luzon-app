        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>NAGACADAN RICE TERRACES</span></h2>

                    </div>
                    <div class="description">
                        Nagacadan Rice Terraces is located at Barangay Nagacadan, Kiangan, Ifugao. The Rice Terraces cluster of Nagacadan was declared a Heritage Site by the UNESCO in 1995 in recognition of its outstanding universal value, specifically for the sustainable and communal system of rice production, for the labor of more than a thousand generations of farmers who has created a landscape using natural resources and for the harmonious interaction of man and environment.The rice terraces cover an expanse of about 150 hectares, displaying the Ifugao indigenous and sustainable agricultural practices. Bisected by a river, the rice terraces appears as two distinct ascending rows.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/naga1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/naga2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/naga3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/naga4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/naga5.webp" style="width:100%">
                        </div>
