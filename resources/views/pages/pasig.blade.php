...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN PASIG</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/ace.jpg" alt="Ace Water Spa" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Ace Water Spa</p>
                    <p class="desc1">Ranking first on the list of things to do in Pasig City is to relax and enjoy at Ace Water Spa. It is a perfect getaway destination for families and friends, offering cozy accommodations, buffet breakfast, and wellness services such as massage, sauna, and herbal pools. Also, their facility is kid-friendly, featuring a designated area for kids.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/ace-water-spa"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Climb Central Manila</p>
                    <p class="desc2">
                    ...
                    <button class="b2" style="vertical-align:middle"><a href="/climb-central-manila"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/climb.jpg" alt="Climb Central Manila" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/rain.jfif" alt="Rainforest Adventure Experience" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Rainforest Adventure Experience</p>
                    <p class="desc1">Pasig Rainforest Park, also known as Pasig City Rainforest Adventure Experience (RAVE Rainforest Park) and Pasig Central Park, is a public park in Pasig, eastern Metro Manila, Philippines. It spans 8 hectares (20 acres), and is a mixed recreational and natural park with a mini-zoo.
                    </p>
                    <button class="b3" style="vertical-align:middle"><a href="/rainforest-adventure-experience"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">The Bike Playground</p>
                    <p class="desc2">The Bike Playground is home to the first and only Velosolutions Pumptrack in the Philippines. Aside from the regular pump track sessions, The Bike Playground also offers bike lessons, skills coaching, trail guiding, and bike trips with Coach Bans Mendoza - a PMBIA certified bike instructor.
                    </p>
                    <button class="b4" style="vertical-align:middle"><a href="/the-bike-playground"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/bike.jpeg" alt="The Bike Playground" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/beer.jpeg" alt="Beer House Kapitolyo Brewing Co." class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Beer House Kapitolyo Brewing Co.</p>
                    <p class="desc1">Other than mall hopping, the best place to enjoy your weekend at Pasig is to enjoy craft beers at the BeerHouse Kapitolyo Brewing Co.
                    </p>
                    <button class="b5" style="vertical-align:middle"><a href="/beer-house-kapitolyo'"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/pasay" class="previous round">&#8249;</a>
                                <a href="/pateros" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
