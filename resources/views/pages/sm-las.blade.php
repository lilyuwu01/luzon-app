        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LAS CASAS FILIPINAS DE ACUZAR</span></h2>
                    ...
                    <div class="description">
                        ...
                        The main attraction of the Las Casas Filipinas de Acuzar is its heritage houses, which were transplanted from outside Bagac, Bataan. The houses are disassembled from their original location and reconstructed inside the premise of the Las Casas Filipinas. This method of heritage conservation has been contentious among conservationists since they believed that their original communities could have benefitted from the structures had they been restored on site.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/las1.jpeg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/las2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/las3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/las4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/las5.jpg" style="width:100%">
                        </div>
