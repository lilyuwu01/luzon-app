        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MOUNT HALCON</span></h2>

                    </div>
                    <div class="description">
                        Mount Halcon s the highest mountain in the island of Mindoro in the Philippines, according to the new data release by Oriental Mindoro peakvisor as of 2022, it has an elevation of 2,616 metres (8,583 ft) above sea level, higher than the previous estimates data at 2,586 m (8,484 ft). It is the 23rd-highest peak in the Philippines and 37th-highest peak of an island on Earth.
                        Its steep slopes have earned it the reputation of being one of the most difficult and technically most challenging mountain to climb in the Philippines. The first documented ascent was made in 1906 by American botanist Elmer Drew Merrill and a party of forestry and military personnel.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/hal1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/hal2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/hal3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/hal4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/hal5.jpg" style="width:100%">
                        </div>
