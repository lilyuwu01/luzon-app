    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/manila"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MANILA ZOOLOGICAL AND BOTANICAL GARDEN</span></h2>

                    </div>
                    <div class="description">
                        The Manila Zoological and Botanical Garden first opened to the public on July 25, 1959, during the tenure of Manila Mayor Arsenio Lacson.
                        The zoo, also known colloquially as Manila Zoo, underwent construction for one year and cost more than ₱1 million to create. Its inauguration was attended by First Lady Leonila Garcia.
                        is erroneously referred to as the oldest zoo in Asia by the Manila city government, partly for which it is marked as a city landmark,
                        despite the establishment of Tokyo’s Ueno Zoo in Japan in 1882.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/manz1.JPG" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/manz2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/manz3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/manz4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/manz5.jfif" style="width:100%">
                        </div>
