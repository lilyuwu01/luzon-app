        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>SUMLANG LAKE</span></h2>

                    </div>
                    <div class="description">
                        Sumlang Lake was once an ugly duckling filled with filthy waters and covered by water lilies. It was there for deacades, competing with Mayon for attention. For years it was ignored. Then one day, in 2014, a "bayanihan" was held and the residents decided to clean and clear the lake of debris. The 14-hectare body of water shone after oodles of waterlilies were taken away from its surface. Then its once hidden potential was discovered. The quiet lake which has been unnoticed for eras made an uproar. Like wildfire, its name conquered various media outlets. It is now an outstanding rendezvous for people looking for the best site to admire the perfect volcano.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/sum1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/sum2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/sum3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/sum4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/sum5.jpg" style="width:100%">
                        </div>
