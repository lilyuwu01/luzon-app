        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>STARWBERRY FARM</span></h2>
                    ...
                    <div class="description">
                        ...
                        The strawberry farm is located in Barangay Betag of La Trinidad, Benguet and is owned and maintained by the Benguet State University (BSU).
                        The BSU leases at least 500 to 1,000 square meters (5,400 to 10,800 sq ft) lots of the 79.49 hectares (196.4 acres) farm to local farmers for strawberry cultivation.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/stra1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/stra2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/stra3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/stra4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/stra5.jpg" style="width:100%">
                        </div>
