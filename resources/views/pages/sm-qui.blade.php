        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>QUIRINO WATERSPORTS COMPLEX</span></h2>

                    </div>
                    <div class="description">
                        A cluster of tourism and water sports facilities, the complex covers 9.5 hectares that feature a wakeboarding facility, a natural lagoon, swimming pool, and other facilities. It is located within the provincial capitol compound, just one kilometer away from the national highway and within view of Susong Dalaga. Facilities include hostels and villas where visitors can book accommodations, a clubhouse, event halls and multipurpose rooms where meeting and seminars for small groups can be held, and an al fresco restaurant that can comfortably fit 100 guests. This restaurant has become a popular venue for weddings and other events, such as the Cagayan Valley leg of Miss Asia Pacific International 2019 beauty pageant that the Quirino provincial government hosted.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/qui1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/qui2.jpeg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/qui3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/qui4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/qui5.jfif" style="width:100%">
                        </div>
