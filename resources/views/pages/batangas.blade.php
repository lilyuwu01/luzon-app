...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN BATANGAS</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/laiya.jpg" alt="Laiya Aplaya" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Laiya Aplaya</p>
                    <p class="desc1">Laiya Aplaya, or simply Laiya, is another seaside barangay that pretty much represents the whole town of San Juan in terms of tourism. 
                        In fact, many beach resorts in other parts of the municipality — like those in nearby Barangay Hugom — are also being marketed with the term Laiya 
                        in tow to catch more attention or spark interest. The long and wide stretch of fine light-colored sand harbors numerous resorts and hotels, ranging 
                        from budget to high-end.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/laiya-aplaya'"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Lobo</p>
                    <p class="desc2">Lobo is notable for its pebble beaches. Instead of shores covered with fine sands, most of the beaches in Lobo, especially in Malabrigo, are carpeted by smooth pebbles and stones.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/lobo"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/lobo.jpg" alt="Lobo" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/mines.png" alt="Fantasy World" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Fantasy World</p>
                    <p class="desc1">Fantasy World is located in Tagaytay because of the close proximity, higher elevation and the backdrop of the rolling hills, but it is, in fact, 
                        in the fringes of the municipality of Lemery in Batangas. The highlight of the park is the towering castle, which was the centerpiece of the plan. If you are 
                        not afraid of heights, you can climb to the top of the main tower and admire the view of the park and the surrounding areas.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/fantasy-world"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Fortune Island</p>
                    <p class="desc2">Fortune Island is one of the beautiful places to visit in Batangas famous for its crumbling pillars called the “Acropolis” 
                        from the Acropolis of Athens in Greece.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/fortune-island"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/fortune.webp" alt="Fortune Island" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/mac.webp" alt="Mount Maculot" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mount Maculot</p>
                    <p class="desc1">Mount Maculot is one of the most popular tourist spots in Batangas especially among mountain climbers and campers. It is standing 947 meters 
                        above sea level and offers magnificent view of Taal Lake, rock formations and forests. It is one of the day-trip or summer destination in Batangas since climbing 
                        is not very difficult (4/10 difficulty level) and it takes only few hours to reach the popular destinations: Rockies, Summit and Grotto which all gives breath-taking scenery.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/mt-maculot"><span> See More</span></a></button>
                    ...
                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                ...
                                <a href="/rizal" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
