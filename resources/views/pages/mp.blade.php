...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN MOUNTAIN PROVINCE</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/bontoc.webp" alt="Bontoc Museum" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Bontoc Museum</p>
                    <p class="desc1">Bontoc Museum showcases the authentic and diverse culture of the different tribes of Mountain Province 
                        including those of Ifugao, Kalinga, and Abra. It houses various artifacts, old photos, weaving materials, farming tools, 
                        indigenous armaments such as spears, and many more.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/bontoc-museum"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">The Hanging Coffins</p>
                    <p class="desc2">The hanging coffins is the famous tourist attraction in Sagada. It's located in the Echo Valley featuring hanging coffins 
                        scattered through the entire area. Seeing these hanging coffins in person truly speaks the importance of culture and reflects the rich heritage 
                        of the locals.
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/the-hanging-coffins"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/hanging.JPG" alt="The Hanging Coffins" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/mogao.webp" alt="Mt. Mog-ao" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mt. Mog-ao</p>
                    <p class="desc1">Mt. Mog-ao stands majestically amidst the rolling plains, making it one of the popular tourist spots in Tadian, Mountain Province. 
                        It is a visible landmark in almost every barangay.  While on top, one can glimpse of the breathtaking views of Sunny Side, adjacent Bauko, and 
                        the municipalities of Quirino and Cervantes in Ilocos Sur province.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/mt-mog-ao"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Mapesak Falls</p>
                    <p class="desc2">Mapesak is one of the most pristine yet least known falls in Mountain Province. It is located deep in the ancestral forests of Lias. 
                        It has two layers, however, only the first layer is readily visible upon reaching the site. Due to its strong water volume, it created a wide and 
                        very deep pool which reflects the dense forests around.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/mapesak-falls"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/mapesak.webp" alt="Mapesak Falls" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/amuyao.webp" alt="Mt. Amuyao" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mt. Amuyao</p>
                    <p class="desc1">Mt. Amuyao in Barlig rises to more than 2, 702-2,862 MASL, making it one of the highest peaks in the Philippines. 
                        Thick mossy and pine forests cover the mountain slopes, providing a haven for endemic and endangered species such as deer, 
                        wild pigs, cloud rats, and civet cats. During the early morning, a breathtaking sea of clouds occasionally appears. Stunning 
                        views of sunrise and sunset best complement these. Mt. Amuyao remains one of the most popular hiking tourist spots in Mountain 
                        Province.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/mt-amuyao"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/kalinga" class="previous round">&#8249;</a>
                                <a href="/baguio" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
