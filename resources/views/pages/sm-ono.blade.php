        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>ONODA TRAIL AND CAVES</span></h2>

                    </div>
                    <div class="description">
                        Onoda Trail and Caves – The forests of Lubang was the hideout of Japanese officer Lt. Hiroo Onoda for 30 years, who was convinced that the war was still not over. The soldier, along with three other comrades, first occupied the forest of Puting Bato Mountain in February 1945 to hide from the Americans who took over Lubang. It reached just 7 months before Japan finally declared their surrender. Unaware, the troops managed to survive on bananas, coconut milk, and hunting, sometimes stealing from the villagers nearby.
                        In 1949, one of Onoda’s men, Private Akatsu, surrendered to the Philippine Army.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ono1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ono2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ono3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ono4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ono5.jpg" style="width:100%">
                        </div>
