...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN SORSOGON</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/bulusan.webp" alt="Mount Bulusan" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mount Bulusan</p>
                    <p class="desc1">It is one of the few remaining last ecological frontiers in the province.
                        Home to a plethora of endangered flora and fauna species, Mount Bulusan, offers an adventure-filled
                        journey of a lifetime. Along the trail, you’ll catch sight of different wildlife, including deer, birds, 
                        wild pigs, and blooming orchids.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/mt-bulusan"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Paguriran Island and Lagoon</p>
                    <p class="desc2">Paguriran Island is just a small rock islet connected to Sorsogon mainland via a sandbar. You can 
                        just walk on this sandbar to reach the island. There, you’ll find a lagoon which is now becoming a popular swimming 
                        site among the locals. Stunning limestone formations surround the lagoon, and you can use these as jumping platforms. 
                        The island is one of the best tourist spots in Sorsogon City.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/paguriran-island-and-lagoon"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/paguri.webp" alt="Paguriran Island and Lagoon" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/busay.webp" alt="Busay Falls" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Busay Falls</p>
                    <p class="desc1">Busay Falls is another laid-back tourist spot in Sorsogon, making it ideal for people who prefer less touristy destinations. 
                        And guess what? There is not only one waterfall here but seven in all, each with unique features to offer. You can explore and enjoy all 
                        these in a day. Only the first two layers, however, are easy to reach because the trails are well-established. It takes an extra dose of 
                        adventurous spirit to assault the other falls.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/busay-falls"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Barcelona Church</p>
                    <p class="desc2">Also referred to as St. Joseph Church, Barcelona Church is one of the historical tourist spots in Sorsogon. Dating back to the Spanish years, 
                        the church was completed in 1874. Another is a stone building, which was an educational center for the Ilustrados or the rich members of the society.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/barcelona-church"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/barcelona.webp" alt="Barcelona Church" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/botong.webp" alt="Botong Twin Falls" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Botong Twin Falls</p>
                    <p class="desc1">Botong Twin Falls is indeed a majestic beauty to behold. Although they cascade near to each other, each fall comes from a different tributary.
                        What makes it even more interesting is that one fall has blue waters as reflected in the pool while the other has greenish waters. The right waterfall has 
                        a height of 40 meters, while the left cascade measures around 25 meters.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/botong-twin-falls"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/masbate" class="previous round">&#8249;</a>
                            </div>
                     </div>
                </div>
            </div>
