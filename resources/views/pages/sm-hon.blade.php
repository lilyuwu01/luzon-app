        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>HONESTY COFFEE SHOP</span></h2>

                    </div>
                    <div class="description">
                        The Honesty Coffee Shop situated near the port of Ivana, Batanes is a quaint self-service coffee shop and one of the most highly respected attractions in the province and in the world.
                        The coffee shop is owned by an Ivatan couple Jose and Elena Gabilo. Elena is a retired public school teacher at Ivana Elementary School and decided to open the store after her retirement. 
                        It was first named as Honesty Café in 1998, but locals mostly refer to it as Honesty Store. Opened in 1995, the place is unmanned which means no one is looking out for it as the owners depend 
                        solely on the honesty of the locals and tourists alike. There are no waitress, manager, or cashier in the shop and everything is self-service, from making your own tea to paying the bill.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/hon1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/hon2.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/hon3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/hon4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/hon5.jpg" style="width:100%">
                        </div>
