        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>GEN. AGUINALDO SHRINE</span></h2>

                    </div>
                    <div class="description">
                        Palanan, Isabela is known to be President Emilio Aguinaldo's last stand. It is because on March 23, 1901 President Aguinaldo and his forces are captured by the American Soldiers which began the end of the Philippine Revolution.
                        The Aguinaldo's Shrine was built on the 100th year anniversary of the historical event which can be found near President Emilio Aguinaldo's house in Palanan, Isabela. This is considered one of the most historical tourist spots in the province.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/gen1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/gen2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/gen3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/gen4.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/gen5.jpg" style="width:100%">
                        </div>
