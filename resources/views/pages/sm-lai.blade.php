        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LAIYA APLAYA</span></h2>

                    </div>
                    <div class="description">
                        Laiya Beach s a beach destination in San Juan, Batangas, Philippines. It is one of the most visited beaches in the country.
                        The beach's sand is composed of weathering-formed crushed shells. Banana boat and jet ski services are offered to people staying in resorts. Fishing boats are also frequently seen near the shores; most of the catch of the fishermen are sold directly to resorts. Vendors roam the beaches, selling souvenir items such as bracelets and butterfly knives.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/lai1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/lai3.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/lai3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/lai4.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/lai5.jpg" style="width:100%">
                        </div>
