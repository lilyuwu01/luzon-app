    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/isabela"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BLUE LAGOON</span></h2>

                    </div>
                    <div class="description">
                        One of the many reasons to travel and explore the province of Isabela is the Palanan’s Blue Lagoon. A mysterious place to visit and the province’s best kept natural attraction. The lagoon has surrounding stories and that locals believe it to be mystical and fairies bathe here causing its blue magical color. Natural or mystical, the lagoon’s raw beauty will surely capture the interest of nature lovers.
                        From Brgy. Didaddungan where the White Beach is located, using the dump truck we rented, it took us around 45 minutes to get to the jump-off to Blue Lagoon in Barangay Villa Robles. From jump-off, we trekked around 15 minutes passing through rice and vegetable fields before we arrived at the lagoon. 
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/blu1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/blu2.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/blu3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/blu4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/blu5.webp" style="width:100%">
                        </div>
