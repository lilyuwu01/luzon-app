        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>ALABANG TOWN CENTER</span></h2>

                    </div>
                    <div class="description">
                    Alabang Town Center opened in 1982 as a strip mall with a supermarket and two cinemas that had the St. Jerome Emiliani and Sta. Susana Parish Church, which was built in the 1970s, as its anchor tenant. The mall was expanded in 1994 and 2007 and became a cosmopolitan Mediterranean-designed, airy lifestyle center.
                    In February 2011, expansion of Alabang center was underway incorporating Metro, which is known for its comfortable and friendly retail outlets all over the country. The four-level Metro replaced the open parking lot near McDonald's housing a department store, a grocery store, and basement parking. Construction commenced last October 20 and the Metro opened in 2012. A new wing linking the Metro became operational late 2011 in which 70 new stores were opened.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ala1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ala2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ala3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ala4.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ala5.jpg" style="width:100%">
                        </div>
