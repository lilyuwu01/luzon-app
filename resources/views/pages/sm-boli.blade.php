        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BOLINAO FALLS</span></h2>

                    </div>
                    <div class="description">
                        Bolinao Falls is a short waterfall  which is a result varying elevations of the Balingasay River, thus the water falls down to a pool of water located on a lower elevation. The "falls" system is part of a stream to which is the water from the Balingasay river is flowing from, then down to the West Philippine Sea.
                        Bolinao Falls is about 19 kilometers away from Bolinao town proper in the middle of a wide field; to which one need to survive 6 kilometers of dirt and rocky road from the national highway of Bolinao. Its location is exactly in the middle of dirt and grasslands of Bolinao between Patar Beach and the main highway.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/boli1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/boli2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/boli3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/boli4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/boli5.jpg" style="width:100%">
                        </div>
