...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <p class="footer-class">TOURIST SPOTS IN ILOCOS SUR</p>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/plaza.jpg" alt="plaza salcedo" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Plaza Salcedo</p>
                    <p class="desc1">Located between Vigan Cathedral and the Provincial Capitol, Plaza Salcedo is a great spot for picture taking at day and turns into a stage of dancing lights at night. The water in the fountain is always right on cue and dances to the beat of the music. What a sight to catch while munching on the best Vigan empanada. 
                        Don’t miss this Vigan Ilocos tourist spot for a fun night!</p>
                <button class="b1" style="vertical-align:middle"><a href="/plaza-salcedo"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Mindoro Beach</p>
                    <p class="desc2">Vigan Ilocos Sur tourist spots are not just about historical places and heritage sites but it also takes pride in sites for RnR. 
                        One of the best spots is Mindoro Beach which offers a front-facing view of the West Philippine Sea. The sand there is black fine and smooth as powder. </p>
                    <button class="b2" style="vertical-align:middle"><a href="/mindoro-beach"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/mindoro.jpg" alt="mindoro beach" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/bantay.jpg" alt="Bantay Church Bell Tower" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Bantay Church Bell Tower</p>
                    <p class="desc1">The Bantay Church Bell Tower served as the town’s watchtower in 1591. The magnificent view that this tourist attraction in Ilocos Sur may have 
                        been the reason why it was supposedly “Diego and Gabriela Silang’s favorite date spot during the 17th century.”</p>
                    <button class="b3" style="vertical-align:middle"><a href="/bantay-church-bell-tower"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Vigan Cathedral</p>
                    <p class="desc2">Another Vigan Ilocos Sur tourist spot to check out is the St. Paul’s Cathedral. Also known as Vigan Cathedral, it is considered a major religious landmark not only in northern Luzon but the country as well. The original structure was built in 1574 with wood and thatch. It was just a mere chapel then. 
                        It was only in 1641 that it was turned into a church and was completed in 1800.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/vigan-cathedral"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/cathedral.jpg" alt="Vigan Cathedral" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/calle.jpg" alt="Calle Crisologo" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Calle Crisologo</p>
                    <p class="desc1">If you want to travel back in time, Calle Crisologo is the best place to be. This tourist spot in Vigan City is a street of old Spanish structures, mostly houses of wealthy families and Filipino-Chinese traders. 
                        This is where you’ll see the famous cobblestone streets that represent Vigan’s image.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/calle-crisologo"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/ilocos" class="previous round">&#8249;</a>
                                <a href="/la-union" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
