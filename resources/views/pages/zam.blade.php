...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <p class="footer-class">TOURIST SPOTS IN ZAMBALES</p>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/ana.webp" alt="Anawangin Cove" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Anawangin Cove</p>
                    <p class="desc1">Anawangin Cove is one of the rising tourist spots in Zambales, 
                        owing to its pristine and rustic condition. Bare mountains shelter the bay. 
                        The beach is ash-colored as a result of the Mt. Pinatubo volcanic eruption.
                        Towering Agoho trees surround the bay, giving it a verdant view. Both locals 
                        and foreign tourists love camping here. A river with crystal-clear waters flows 
                        to the bay.</p>
                <button class="b1" style="vertical-align:middle"><a href="/anawangin-cove"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Botolan Resettlement Sites</p>
                    <p class="desc2">This is one of the sites to catch one of the best views of Mt. Pinatubo’s crater. 
                        Aetas indigenous groups who were displaced during the 1991 Mt. Pinatubo eruption, live here.
                        Today, it’s a venue for appreciating the beauty of the mountain and learning the culture of the 
                        Aetas. The site is one of the recognized cultural tourist spots in Botolan, Zambales</p>
                    <button class="b2" style="vertical-align:middle"><a href="/botolan-resettlement-sites"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/boto.webp" alt="Botolan Resettlement Sites" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/capones.webp" alt="Capones Island" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Capones Island</p>
                    <p class="desc1">Capones Island is one of the most popular tourist spots in Zambales. Called “Isla de Gran Capon” 
                        during the Spanish period, the island features a pebbled beach with white sands. It’s the ultimate getaway for 
                        those into surfing and diving. The surrounding seas teem with rich marine species, thanks to local conservation efforts.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/capones-islands"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">The Hellships Memorials</p>
                    <p class="desc2">The Hellpships Memorial commemorates both Filipino and American soldiers who fought and perished during 
                        the Japanese occupation. It is also a good place to relax and meditate about life. It is one of the historical tourist 
                        spots in Subic, Zambales.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/the-hellship-memorials"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/hell.webp" alt="The Hellships Memorials" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/talisayen.webp" alt="Talisayen Cove" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Talisayen Cove</p>
                    <p class="desc1">Talisayen Cove is one of the least known tourist attractions in Zambales. The peaceful, 
                        serene, and rustic atmosphere makes this a perfect getaway for those who prefer off-beaten destinations.
                        In fact, extreme travelers love coming here, some setting their own trails and adventurers</p>
                    <button class="b5" style="vertical-align:middle"><a href="/talisayen-cove"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                        <div class="next-page">
                            <a href="/tarlac" class="previous round">&#8249;</a>
                    </div>
            </div>
                </div>
            </div>
