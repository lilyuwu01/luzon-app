    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/oriental-mindoro"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
                ...
                <div class="back2">
                    <a href="/oriental-mindoro">Back</a>
                </div>
            </div>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>TUKURAN FALLS</span></h2>

                    </div>
                    <div class="description">
                        Tukuran Falls is best known for its gentle, crystal clear waterfalls. Going here is an adventure itself, which you can do so by walking or by riding a carabao. Though the trek can be a bit challenging, it’s actually a refreshing trek. Apart from seeing the lovely waterfalls itself, what made this trip memorable were the nice weather, scenic view, and delicious snacks!
                        Tukuran Waterfalls is just a one-hour drive then a 30-minute walk from BADLADZ Beach & Dive Resort making it the perfect daytime activity for you and your group to get out and do some exploring around the island during your stay. Along the way, you will also visit Tamaraw Waterfalls which has its own scenic beauty.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/tu1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/tu2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/tu3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/tu4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/tu5.jpg" style="width:100%">
                        </div>
