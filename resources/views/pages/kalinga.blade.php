...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN KALINGA</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/binasalan.webp" alt="Binasalan Falls" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Binasalan Falls</p>
                    <p class="desc1">Binalasan Falls is one of the rustic tourist spots in Kalinga province. Its waters emanate from the dense mossy forests of Mt. Binuluan. 
                        It cascades for more than 30 meters on a very deep pool. Swimming in the pool can be quite dangerous due to its strong and churning current. Summer 
                        then would be the best time to visit. Verdant vegetation of shrubs, mosses, and grasses surround its base. To get here, one needs to hike for at least 
                        an hour or more from the road. Literally, you’ll climb over steep trails and jump across boulders before finally catching sight of the falls.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/binalasan-falls"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Tumuyoc Falls</p>
                    <p class="desc2">Tumuyoc falls measures around 30 feet high and cascades to a wide and very deep pool. Its waters are icy-cold and crystal-clear.
                        The pristine waters also host endemic marine species such as small fishes, eels, and crabs. These are part of the common foods of the locals, 
                        cooked in indigenous ways.
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/tumuyoc-falls"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/tumuyoc.webp" alt="Tumuyoc Falls" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/buaya.webp" alt="Buaya Caves" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Buaya Caves</p>
                    <p class="desc1">Buaya caves feature various stalactite and stalagmite rock formations. There are beautiful chambers inside, 
                        reminiscent of a cathedral’s domes and spires.In some parts of the cave, you would feel like you are in the golden chamber. 
                        The caves are interconnected from each other and form a chain covering the whole mountain slope.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/buaya-caves"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Lubo and Mangali Rice Terraces</p>
                    <p class="desc2">From the road, these terraces look like circular cascades. They surround the village of Lubo. The Tanudan river passes alongside these terraces.
                        Towering mountains provide a dramatic background of these terraces. They also supply abundant water supply all year round. 
                        Aside from the terraces, the hospitality of the people would definitely leave you feeling blissful.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/lubo-and-mangali-rice-terraces"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/lubo.webp" alt="Lubo and Mangali Rice Terraces" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/dulag.webp" alt="Dulag Historical Marker" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Dulag Historical Marker</p>
                    <p class="desc1">Dulag Historical Marker was unveiled on April 23, 2017, commemorating the heroic struggle of Macliing Dulag, 
                        a tribal elder who pitied the communities of Bontoc and Kalinga against the mega-dam projects of the Marcos regime.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/dulag-historical-marker"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/ifugao" class="previous round">&#8249;</a>
                                <a href="/mount-province" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
