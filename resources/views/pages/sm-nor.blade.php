    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/benguet"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>NORTHERN BLOSSOM FLOWER FARM</span></h2>

                    </div>
                    <div class="description">
                        Northern Blossom Flower Farm is a two-hectare farm with mountain views located in Atok, Benguet. It features echeveria plants, colorful rose cabbages, vibrant sunflowers, pastel-colored flowers, marigolds, delphinium, Matthiola, and roses planted in wide rolling fields. Because of its gaining popularity in the past years by means of social media platforms, the Northern Blossom Flower Farm got featured in popular TV shows such as Kapamilya News, Matanglawin, and Kapuso mo Jessica Soho.
                        Northern Blossom Flower Farm is a nine-hour drive from Metro Manila and a two-hour drive from Baguio City. Many visitors coming from the National Capital Region go to this beautiful place to experience the spring and the flower boom that is very similar to Japan and South Korea.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/nor1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/nor2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/noe3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/nor4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/nor5.jpg" style="width:100%">
                        </div>
