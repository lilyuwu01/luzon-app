        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MARCELO H. DEL PILAR MUSEUM</span></h2>

                    </div>
                    <div class="description">
                        The Marcelo del Pilar Historical Landmark stands on the exact site of the hero's birthplace.  His remains are buried in the shrine.  Inside the shrine is a museum displaying Del Pilar memorabilia.
                        Del Pilar was a reformist who wrote and advocated for Philippine reforms during the Spanish colonial era.
                        He published several newspapers in Tagalog and Spanish, specifically criticizing the church for oppressing and taking advantage of the natives.  He advocated for better civil liberties for the native people, Filipino participation in government, and representation in the Spanish government in Spain.
                        Persecuted by the clergy, he went to exile in Hongkong where he became editor of the pro-reform newspaper La Solidaridad. 
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/marc1.jfif" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/marc2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/marc3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/marc4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/marc5.jpg" style="width:100%">
                        </div>
