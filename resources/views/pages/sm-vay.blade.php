        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>VAYANG ROLLING HILLS</span></h2>

                    </div>
                    <div class="description">
                        Vayang Rolling Hills is located in Basco, Batan Island, Batanes. The hills are also called as Vayang Ranch.
                        The hills offer beautiful and stunning views of verdant grass and deep blue sea. The surroundings are covered
                        with color green - the hills, trees, and grass. The environment is very relaxing to the eyes; you can think and 
                        dream peacefully while looking at the clouds. The clouds have different shapes and sizes; the air is refreshing 
                        because of the cool breeze coming from the sea. You can also see some cows that are eating and dogs that are running. 
                        The place has a good weather and environment.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/vay1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/vay2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/vay3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/vay4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/vay5.jpg" style="width:100%">
                        </div>
