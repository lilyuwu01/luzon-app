...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN MANDALUYONG</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/mega.jpg" alt="SM Megamall" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">SM Megamall</p>
                    <p class="desc1">SM Megamall is a large shopping mall located in the Ortigas Business Centers of Metro Manila. It is one of the largest SM Supermall developed 
                        and operated by SM Prime Holdings, the largest mall operator in the Philippines owned by Henry Sy Sr. </p>
                    <button class="b1" style="vertical-align:middle"><a href="/sm-megamall"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Shangri-La Plaza Mall</p>
                    <p class="desc2">Shangri-La Plaza Mall is an upscale shopping mall situated in the Ortigas Center, a business/commercial district of 
                        Mandaluyong City. It is surrounded by four streets in the commercial area, namely, Internal Avenue, St. Francis Avenue, Shaw Boulevard 
                        and the major highway EDSA.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/shangri-la-plaza-mall"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/shangri.jpg" alt="Shangri-La Plaza Mall" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/greenf.jpg" alt="Greenfield Weekend Market" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Greenfield Weekend Market</p>
                    <p class="desc1">Rich with adventures on food, shopping, vintage, art, music and even fortune telling, Greenfield Weekend Market promises to showcase Metro Manila's most unique finds 
                        and to be a unique outdoor family destination --- all nestled in a wide, green expanse in the middle of the city.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/greenfield-weekend-market"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">St. Francis Square Mall</p>
                    <p class="desc2">St. Francis Square Mall, is one of the notable shopping center in the city, the mall is a modern low-rise building holding a 3,000 capacity auditorium 
                        and houses over 1,000 stalls and stores. St. Francis Square Mall is a five-storey shopping mall located in the heart of Ortigas Center and part of the St.
                        Francis Square Complex.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/st-francis-square-mall"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/square.jpg" alt="St. Francis Square Mall" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/dambana.jfif" alt="Dambana ng mga Alaala" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Dambana ng mga Alaala</p>
                    <p class="desc1">A monument for the people who struggled for liberty and freedom during the revolution period.
                        The monument features “Inang Kalayaan” with her hands raised up victoriously while freedom-fighting soldiers 
                        and Katipuneros surround her.

                    </p>
                    <button class="b5" style="vertical-align:middle"><a href="/dambana-ng-mga-alaala"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/malabon" class="previous round">&#8249;</a>
                                <a href="/manila" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
