        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MAPESAK FALLS</span></h2>

                    </div>
                    <div class="description">
                        Mapesak is one of the most pristine yet least known falls in Mountain Province. It is located deep in the ancestral forests of Lias. It has two layers, however, only the first layer is readily visible upon reaching the site.
                        Due to its strong water volume, it created a wide and very deep pool which reflects the dense forests around.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/map1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/map2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/map3.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/map4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/mapesak.webp" style="width:100%">
                        </div>
