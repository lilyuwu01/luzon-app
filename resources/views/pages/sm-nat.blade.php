    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/las-pinas"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>NATURE CHURCH</span></h2>

                    </div>
                    <div class="description">
                        Nestled inside the city landscape of Las Piñas is the charming nook that is called Nature Church or Parish of Mary Immaculate Church. This quiet spiritual sanctuary is a sprawling area of natural beauty. Inside the church grounds are full of tall and shady trees. In fact, the church is situated in a half-century old mango orchard, and everything was well preserved. None of the trees were cut down during the construction of the church, and most of the materials used in building it were cast off construction materials.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/nat1.jfif" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/nat2.JPG" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/nat3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/nat4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/nat5.JPG" style="width:100%">
                        </div>
