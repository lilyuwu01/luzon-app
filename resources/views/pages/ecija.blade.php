...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <p class="footer-class">TOURIST SPOTS IN NUEVA ECIJA</p>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/carron.webp" alt="Carron Dream Park" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Carron Dream Park</p>
                    <p class="desc1">Carron Dream Park is the perfect place for kids to let their imagination run wild. 
                        Themed around a magical kingdom, the park features a variety of rides, shows, and attractions 
                        that will keep kids entertained for hours on end. </p>
                <button class="b1" style="vertical-align:middle"><a href="/carron-dream-park"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Minalungao National Park</p>
                    <p class="desc2">Minalungao National Park is another hidden gem in Nueva Ecija. This natural river park is known for 
                         its unique magnificent rock formation. Visitors to the park can enjoy activities such as cliff diving, fishing, 
                         and traditional bamboo raft ride. he park also offers stunning views of the river, making it a popular destination 
                         for nature lovers and adventure seekers alike. Whether you’re looking for a thrill or a peaceful escape, Minalungao 
                         National Park is sure to have something for you.
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/minalungao-national-park"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/mina.jpg" alt="Minalungao National Park" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/farm.jpg" alt="Farm Villaronte’s Flower Farm" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Farm Villaronte’s Flower Farm</p>
                    <p class="desc1">Farm Villaronte’s Flower Farm is a picturesque spot where visitors can 
                        enjoy scenic walks through the fields of flowers. Set against the backdrop of a colorful 
                        windmill and watchtower, the fields of flowers offer scenic views that are sure to take your 
                        breath away.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/farm-villarontes-flower-farm"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Rancho De Cabileo </p>
                    <p class="desc2"> This ecological park is situated in Brgy. Cabileo, Cuyapo and offers stunning views of Colosboa Hills. 
                        You can also rent a boat to explore the area further or enjoy an intimate picnic lunch prepared by the staff. 
                        No matter what you choose to do, Rancho De Cabileo is sure to provide you with a truly memorable experience.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/rancho-de-cabileo"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/rancho.jfif" alt="Rancho De Cabileo" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/forest.jfif" alt="Forest Garden" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Forest Garden</p>
                    <p class="desc1">Forest Garden is a hidden oasis that offers stunning views of the surrounding forest. 
                        The cafe itself is a verdant oasis, with kudos providing overnight accommodations for guests. 
                        Forest Garden is also home to beautiful wood carvings, making it the perfect spot for an Instagram
                        photo op</p>
                    <button class="b5" style="vertical-align:middle"><a href="/forest-garden"><span> See More</span></a></button>

                    <div class="see-more">
                            <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                                <div class="next-page">
                                    <a href="/bulacan" class="previous round">&#8249;</a>
                                    <a href="/pampanga" class="next round">&#8250;</a>
                                </div>
                     </div>
                </div>
            </div>
                    ...
                    <div class="choices-box">
                        <div class="button-container">
                            <div class="move">
                                ...
                                <div class="button8">
                                    <a href="ncr.html"><button type="button"><svg class="eight" xmlns="http://www.w3.org/2000/svg"
                                        preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                        <path fill="white" d="M12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 
                                        14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 
                                        12 2q3.65 0 6.387 2.287q2.738 2.288 3.413 5.738h-2.05q-.475-1.825-1.712-3.263Q16.8 
