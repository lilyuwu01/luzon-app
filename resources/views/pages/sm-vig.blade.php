        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>VIGAN CATHEDRAL</span></h2>

                    </div>
                    <div class="description">
                        The Vigan Cathedral was first built in 1574 by Spaniard Juan de Salcedo.  After it was damages by earthquake in 1619 and 1627, it was reconstructed in 1641.  In 1739, it was damaged by fire.  
                        And, in 1790 it was again reconstructed and finished in 1800 to its current structure. It still contained most of the original features of the church interior.  It has not thick walls to withstand 
                        earthquakes and typhoons.  When the seat of the Diocese of Nueva Segovia was transferred from Cagayan to Vigan, it became a cathedral. The Vigan Cathedral has twelve altars with hammered-silver panels, three naves, and a choir loft.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/vig1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/vig2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/vig3.JPG" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/vig4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/vig5.jpg" style="width:100%">
                        </div>
