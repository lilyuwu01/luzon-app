        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BALESIN ISLAND</span></h2>

                    </div>
                    <div class="description">
                        Balesin Island is a tropical island and barangay off the eastern coast of Luzon in the Philippines. It is located in Lamon Bay and is administered as part of the municipality of Polillo of Quezon province.
                        Balesin Island was once owned by businessman Baby Ysmael. The island was later acquired from Ysmael by Edgardo “Ed” Tordesillas, who began to develop it with basic facilities for tourism. Early customers were predominantly Japanese. Today Balesin Island is a property of Alphaland Corporation,
                        a private company majority owned by its Chairman Roberto Ongpin, a prominent Filipino businessman.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bal1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bal2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bal3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bal4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bal5.jpg" style="width:100%">
                        </div>
