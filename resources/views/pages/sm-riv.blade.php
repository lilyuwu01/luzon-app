        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MARIKINA RIVER PARK</span></h2>

                    </div>
                    <div class="description">
                        The park was developed as part of a rehabilitation program called Save the Marikina River Program by the Marikina city government. Launched in 1993, the program aims to reduce flooding and improve the Marikina riverbanks for better water discharge after a 1992 flood left 25% of the city under floodwater.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/riv1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/riv2.png" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/riv3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/riv4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/riv5.jpg" style="width:100%">
                        </div>
