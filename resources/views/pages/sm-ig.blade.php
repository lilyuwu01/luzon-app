    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/occidental-mindoro"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
                ...
                <div class="back2">
                    <a href="/occidental-mindoro">Back</a>
                </div>
            </div>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MOUNT IGLIT-BACO NATIONAL PARK</span></h2>

                    </div>
                    <div class="description">
                        The Mounts Iglit–Baco National Park is a protected area of the Philippines and an ASEAN Heritage Park located in the island of Mindoro in central Philippines. The park covers an area of 75,445 hectares (186,430 acres) surrounding Mount Iglit and Mount Baco in the central interior of Mindoro.
                        It was established in 1970 by virtue of Republic Act No. 6148. In 2003, the Association of Southeast Asian Nations listed it as one of its four heritage parks in the Philippines.
                        The park has also been nominated in the Tentative List of UNESCO World Heritage Sites.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ig1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ig2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ig3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ig4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ig5.webp" style="width:100%">
                        </div>
