    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/bulacan"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>GUIGUINTO OLD TRAIN STATION</span></h2>

                    </div>
                    <div class="description">
                        Guiguinto station is a former railway station located on the North Main Line in Bulacan, Philippines. The station was once part of the line until its discontinuation in 1988.
                        It is currently being rebuilt as part of the first phase of the North–South Commuter Railway.
                        As part of the project, the old station will also be restored.[4] The station is parallel to McArthur Highway, and it is near to the San Ildefonso Church and to the Municipal Hall.
                        The station, then known as the Estacion de Guiguinto, was inaugurated in 1891. It was the first railway station serving Guiguinto.
                        t is a notable historical landmark in the municipality. It was upon this site that the Katipuneros ambushed a train from Dagupan, killing six friars, including the parish priest of Guiguinto, Fr. Leocadio Sanchez, and a Spanish doctor.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/gui1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/gui2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/gui3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/gui4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/gui5.jpg" style="width:100%">
                        </div>
