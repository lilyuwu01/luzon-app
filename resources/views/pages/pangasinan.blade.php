...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <p class="footer-class">TOURIST SPOTS IN PANGASINAN</p>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/hundred.jpg" alt="Hundred Islands" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Hundred Islands</p>
                    <p class="desc1">Hundred Islands is one of the most popular tourist spots in Pangasinan, a group of around 123 small islands and islets scattered in the Lingayen Gulf. These mushroom-like islets are composed of limestone rocks at its base with thick vegetation above it. Though not every islet has beautiful beaches, there are some that has its own white sand coves. The most popular islands are the Governor’s Island, Quezon Island, Marcos Island and Children’s Island for day tours and overnight camping activities.</p>
                <button class="b1" style="vertical-align:middle"><a href="/hundred-islands"><span> See More</span></a></button>
            ...
            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Bolinao Falls</p>
                    <p class="desc2">Bolinao Falls is a beautiful waterfall tucked away in a peaceful location. The different heights of the Balingasay River create a short cascade and
                         the waterfalls to a pool at a lower level. The waterfall system is part of a stream that flows from the Balingasay River to the West Philippine Sea. </p>
                    <button class="b2" style="vertical-align:middle"><a href="/bolinao-falls"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/bolinao.jpg" alt="Bolinao Falls" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/enchanted.jpg" alt="Enchanted Cave" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Enchanted Cave</p>
                    <p class="desc1">Enchanted Cave is among the most visited tourist spots in Pangasinan. It is a well-maintained cave and the center of attraction is the cool and calm turquoise spring pool inside the cave. 
                        Getting inside is easy since a man-made staircase was built leading to the cave’s mouth for convenience of visitors.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/enchanted-cave"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Tondal Beach</p>
                    <p class="desc2">Tondol Beach is another beautiful beach in Pangasinan. It features a long and wide expanse of white sand with very shallow crystal clear waters and its shores are dotted with coconut trees. If you visit here during low tide, you might wonder where did all the sea water go since low tide in Tondol Beach literally means almost all waters were sucked up far from the shoreline.It is even possible to reach the nearby island on foot during low tide.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/tondal-beach"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/tondal.webp" alt="Tondal Beach" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/tambobong.jpg" alt="Tambobong Beach" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Tambobong Beach</p>
                    <p class="desc1">Tambobong Beach is one of the famous tourist spots in Pangasinan. It has a long stretch of creamy light brown sand and blue waters. 
                        The beach has calm and alluring sea waters but the docking boats in the shore and some part with sea grasses are disappointment to many tourists. 
                        Well, you can’t please everybody. But if you are with your group of friends or family with open-mind who just want to relax and enjoy the beach while staying at a beach resort, this place is for you.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/tambobong-beach"><span> See More</span></a></button>

                    <div class="see-more">
                            <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                                <div class="next-page">
                                    <a href="/la-union" class="previous round">&#8249;</a>
                                </div>
                            </div>
                    </div>
            </div>
