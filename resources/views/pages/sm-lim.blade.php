        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LIMUTAN FALLS</span></h2>
                    ...
                    <div class="description">
                        ...
                        The magnificent Limutan falls is located 5-10 minutes away from the campsite. Approximately 20 meter high, 4-5 meters wide and more than 10 feet deep. Even on summer days, water is still chilly. Choose from any of several pools between the two falls.
                        Mountain biking is possible and also recommended
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/lim1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/lim2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/lim3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/lim4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/lim5.jpg" style="width:100%">
                        </div>
