        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>KAMAY NI HESUS SHRINE</span></h2>

                    </div>
                    <div class="description">
                        Kamay ni Hesus Healing Center was built in 2002 under the initiative of the healing priest Fr. Joey Faller with the help of the people of Quezon. It is a 5-hectare land with a church and chapel, a grotto on a hill that you can climb for 300+ steps and a 50-foot statue of the Ascending Christ on top, a garden (Garden of Eden) that has some life-size statues of some people from the bible, a replica of Noah's ark which also acts as a Retreat house as well as a souvenir shop.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/kam1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/kam2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/kam3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/kam4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/kam5.jpg" style="width:100%">
                        </div>
