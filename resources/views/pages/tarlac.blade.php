...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <p class="footer-class">TOURIST SPOTS IN TARLAC</p>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/anzap.webp" alt="ANZAP Twin Falls" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">ANZAP Twin Falls</p>
                    <p class="desc1">ANZAP (ASEAN-New Zealand Afforestation Program) Twin Falls cascades towards a 
                        beautiful catch basin for more than 200 feet. Trekking to the falls will lead you into the 
                        lush forests of Tarlac, home to endangered flora and fauna species. It’s a perfect getaway 
                        for those wanting to escape the lowland heat. </p>
                <button class="b1" style="vertical-align:middle"><a href="/anzap-twin-falls"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Mount Damas</p>
                    <p class="desc2">Mount Damas rises to more than 685 meters above sea level. It’s one of the 
                        favorite climbing destinations in Tarlac. You’ll have a panoramic view of the mountain ranges 
                        and vast rice fields of Tarlac and Pangasinan from the top. Expect to trail on rocks and boulders, 
                        streams, and tall grasses before reaching the summit. </p>
                    <button class="b2" style="vertical-align:middle"><a href="/mt-damas"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/arayat.jpg" alt="Mount Damas" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/capas.webp" alt="Capas National Shrine" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Capas National Shrine</p>
                    <p class="desc1">Capas National Shrine pays tribute to the Filipino and American soldiers who fought 
                        the Japanese invaders during World War II. A 70-meter monolith stands with a list of soldiers who 
                        perished during the war inscribed. It is one of the recognized historical tourist spots in Tarlac.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/capas-national-shrine"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Calao Falls</p>
                    <p class="desc2">Calao Falls is a two-layered cascade. The main layer measures around 20 feet high with a 
                        circular catch basin. The pool is ideal for swimming, and it has cold and crystal-clear waters.
                        Tropical forests surround the waterfall. Wild fruits also abound. You’re lucky if you come here 
                        when these fruits are ripe.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/calao-falls"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/calao.webp" alt="Calao Falls" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/mona.webp" alt="Monasterio De Tarlac" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Monasterio De Tarlac</p>
                    <p class="desc1">Monasterio de Tarlac is a favorite pilgrimage destination in Tarlac, located on a site that 
                        is 300 meters above sea level. It boasts of a towering statue of Jesus Christ overlooking Tarlac’s plains.
                        The statute signifies the Catholic faith of the people. It is one of the most frequented tourist spots in Tarlac.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/monasterio-de-tarlac"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/pampanga" class="previous round">&#8249;</a>
                                <a href="/zambales" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
