    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/laguna"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>ENCHANTED KINGDOM</span></h2>

                    </div>
                    <div class="description">
                        Enchanted Kingdom was formally incorporated in 1992, conceptualised and planned for from 1992 to 94, broke ground in August 1994 and officially opened on October 19, 1995. The park was founded and funded by a group of businessmen/friends led by Cesar Mario O. Mamon and his brother-in-law Rafelito E. Minguez, who initially served as its chairman of the board and president and CEO respectively. From 1999 onwards, Cesar Mario O. Mamon has served in a concurrent capacity as the park’s chairman, president and CEO.
                        Enchanted Kingdom initially opened as a themed amusement park divided into seven themed zones.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ek1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ek2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ek3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ek4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ek5.jpg" style="width:100%">
                        </div>
