        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>GOLOLAN FALLS</span></h2>

                    </div>
                    <div class="description">
                        The story behind the name goes that two water creatures kiwat (eel) and aguning (fish related to tilapia) wanted to climb the waterfalls. However, only the kiwat was able do so. The aguning who was left behind cried out, “Magol-olol” which meant, “Help, I'm stuck!”. Thus, it was called Gololan Falls.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/gol1.jfif" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/gol2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/gol3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/gol4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/gol5.jpg" style="width:100%">
                        </div>
