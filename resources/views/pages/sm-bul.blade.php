        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BULALACAO ISLAND</span></h2>

                    </div>
                    <div class="description">
                        Known as the gem of Oriental Mindoro, the island’s southernmost town of Bulalacao is best known as an island hopping destination with at least 11 scattered islands and islets believed to come from a meteor that landed in the area, thus the name “Bulalakaw”. It is famous for laid-back beach bumming in white sand shores and waters teeming with marine life.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bul1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bul2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bul3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bul4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bul5.jpg" style="width:100%">
                        </div>
