    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/national-capital-region"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
                ...
                <div class="back2">
                    <a href="/national-capital-region">Back</a>
                </div>
            </div>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>THE CHINESE CEMETARY</span></h2>

                    </div>
                    <div class="description">
                        Prior to the establishment of the Manila Chinese Cemetery, Chinese who observed Buddhism had their burial grounds on a hill slope in Bangkusay, Tondo, near San Lazaro Hospital. In 1843, the Governor-General authorized the Chinese to establish a cemetery in La Loma.
                        It was founded by Lim Ong and Tan Quien Sien (Carlos Palanca) in the 1850s. t was also enlarged on its present site in 1863 when Ong, the gobernadorcillo (mayor) of the Chinese community in Binondo, purchased land in La Loma to provide a decent burial ground for Catholic and non-Catholic Chinese.
                        t would also cater outcasts of society (like those that died from contagious diseases and people who are political enemies of the Spanish Crown) excluded from the nearby La Loma Cemetery's consecrated grounds. It was also later expanded in 1878 by Don Mariano Fernando Yu Chingco, a subsequent gobernadorcillo, when he bought land worth ₱14,000 to expand the cemetery from the Dominican Provincial which used to own the Hacienda de La Loma from which the cemetery was built. This cemetery catered the poor Chinese who could not afford to return to China to bury or send their dead.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/chi1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/chi2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/chi3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/chi4.avif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/chi5.jpg" style="width:100%">
                        </div>
