    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/masbate"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>AROROY LIGHTHOUSE</span></h2>

                    </div>
                    <div class="description">
                        Set on the hill in Bagui Point, an hour and a half from Masbate is Aroroy Lighthouse. Located in the northern part of Masbate Island, this centuries-old lighthouse is one of the many lighthouses built during the Spanish colonial era but this particular lighthouse was constructed in 1896, the year when the Filipinos began their revolution against their Spanish colonizers. Thus it took some years for it to be functional – during the American Occupation in the country. The lighthouse bears similarity to other Spanish-era lighthouses in the Philippines. Rustic, this is one historical structure to visit without the crowd.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/aro1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/aro2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/aro3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/aro4.JPG" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/aro5.jfif" style="width:100%">
                        </div>
