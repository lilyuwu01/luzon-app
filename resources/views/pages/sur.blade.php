...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN CAMARINES SUR</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/isa.webp" alt="Mount Isarog" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mount Isarog</p>
                    <p class="desc1">Standing mightily amidst the plains and hills is Mount Isarog. It’s one of the protected tourist spots in Camarines Sur, 
                        owing to its rich but threatened biodiversity. Enchanting mossy forests cover the higher elevations while endangered dipterocarp forest 
                        occupies the lower elevations. These forests host a plethora of wildlife species, many of which can only be found here, including the Isarog 
                        cloud rat. On Mount Isarog’s slopes, one can find numerous waterfalls with icy-cold and crystal-clear waters.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/mt-isarog"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Lake Buhi</p>
                    <p class="desc2">These tiny fishes are locally known as Sinarapan and are a favorite local delicacy. Nestled between majestic Mount Malinao and Mount Asog, 
                        the lake covers around 1600 hectares. You can hop on a boat to relish the beauty of the lake and the surrounding lush sceneries. If you want to level up 
                        your visit, you can hike to the surrounding forests. There, you’ll chance on different wildlife species such as parrots, monkeys, monitor lizards, and woodpeckers.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/lake-buhi"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/bagas.jpeg" alt="Lake Buhi" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/caramoan.jpg" alt="Caramoan Islands" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Caramoan Islands</p>
                    <p class="desc1">If you’re looking for a memorable island hopping experience, don’t miss visiting Caramoan Islands. 
                        Boasting of pristine white beaches and crystal-clear waters, the island is one of the secluded tourist spots in Camarines Sur. </p>
                    <button class="b3" style="vertical-align:middle"><a href="/caramoan-islands"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Lahuy Island</p>
                    <p class="desc2">Seeking tranquility amidst the echo of the rushing waves and the rustling of trees? Ah, Lahuy Island should make up to your bucket list. It measures 10 kilometers long and 3 kilometers wide. 
                        Because of its secluded location, it’s one of the off-beaten tourist spots in Camarines Sur. Enjoy strolling on the creamy-white beaches or navigating your way on the dense forests nearby.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/lahuy-island"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/lahuy.webp" alt="Lahuy Island" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/pena1.jpg" alt="Penafranca Basilica Minore" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Penafrancia Basilica Minore</p>
                    <p class="desc1">Our Lady of Penafrancia Church, the Basilica is one of the historical tourist spots in Camarines Sur. 
                        It dates back to the Spanish regime and has been a tangible witness to the province’s rich culture and history.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/penafrancia-basilica-minore"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/camarines-norte" class="previous round">&#8249;</a>
                                <a href="/catanduanes" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
