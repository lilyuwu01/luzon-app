        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LOTUS VALLEY FARM</span></h2>
                    ...
                    <div class="description">
                        ...
                        Meanwhile, enveloped in the farm’s lush forest is a central area dedicated for vegetation, meditation, and off-beat accommodation. One can easily spend days exploring the many fresh vegetation, having mini-detox sessions, or even just marveling at the sights and sounds from the comfort of the farm’s cozy bamboo huts. Not to be missed is the bed of enchanting Lotus flower plants in 
                        the far end of the garden.  All organically grown, of course!
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/lot1.png" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/lot2.png" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/lot3.JPG" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/lot4.JPG" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/lot5.jpg" style="width:100%">
                        </div>
