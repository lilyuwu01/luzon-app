...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN ORIENTAL MINDORO</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/hal.webp" alt="Mount Halcon" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mount Halcon</p>
                    <p class="desc1">Mount Halcon soars to 8,484 feet above sea level, making it the 18th highest mountain in the Philippines. 
                        It is considered as the most difficult mountain to climb in the entire country. Expect to cross brooks and rivers, 
                        trail on dense forests and steep terrains before finally reaching the summit. But all these are worth it because of 
                        the marvelous sights to see including towering waterfalls, mossy forests, orchids, crystal-clear rivers, birds, and 
                        many more. It is one of the protected tourist spots in Oriental Mindoro.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/mt-halcon"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Tukuran Falls</p>
                    <p class="desc2">Tukuran Falls, dubbed as the Hidden Paradise, the falls lies on a remote jungle, home to various flora and fauna species.
                        Some locals climb to the top of the falls and jump their way right into the deep pool. It has cold and crystal-clear waters.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/tukuran-falls"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/tuku.jpg" alt="Tukuran Falls" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/arigoy.webp" alt="Arigoy River" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Arigoy River</p>
                    <p class="desc1">If you’re hyped up for a thrilling experience, try whitewater kayaking in Arigoy River. 
                        That entails a two-hour adventure with all the paddling and splashing. Enjoy relishing the cold and 
                        crystal-clear waters as you gaze on the lush views. Emanating from forested mountains, the river is 
                        one of the cleanest in the entire province. Arigoy River is one of the emerging tourist spots in Oriental Mindoro.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/arigoy-river"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Bulalacao Island</p>
                    <p class="desc2">Bulalacao Island is another off-beaten tourist spots in Oriental Mindoro to see. It consists of at least 
                        13 untouched islets. From a certain vantage point, these islets resemble the shape of a shooting star, thus, the name.
                        ere, you’ll find unspoiled beaches and enticing waters filled with marine species.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/bulalacao-island"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/bula.webp" alt="Bulalacao Island" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/ono.webp" alt="Onoda Trail and Caves" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Onoda Trail and Caves</p>
                    <p class="desc1">Lt Hiroo Onoda gained fame when he refused to surrender even after World War II. For years, 
                        he has been hiding on a remote mountain until the Japanese government intervened and convinced him to finally come out.
                        If you want to know more about this, check out the Onoda Trail and Caves. It runs for eight kilometers with four interconnected caves. 
                        Trekking to these spots will also take you to crystal-clear streams, century-old trees, and wildlife species</p>
                    <button class="b5" style="vertical-align:middle"><a href="/onoda-trail-and-caves"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/occidental-mindoro" class="previous round">&#8249;</a>
                                <a href="/palawan" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
