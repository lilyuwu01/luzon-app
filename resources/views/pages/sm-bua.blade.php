        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BUAYA CAVES</span></h2>

                    </div>
                    <div class="description">
                        Buaya is a local term for crocodile, but you won’t see any of these ferocious reptiles in the Buaya Caves. Instead, you will see the usual stalactites and stalagmites formation that make any cave a natural wonder. Because Buaya Caves are made up a number of caves that cover the whole mountain slope, which are interconnected with each other, it is best to explore it with a local guide.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bua1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bua2.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bua3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bua4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bua5.jpg" style="width:100%">
                        </div>
