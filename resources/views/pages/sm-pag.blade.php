    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/sorsogon"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>PAGURIRAN ISLAND AND LAGOON</span></h2>

                    </div>
                    <div class="description">
                        A little gem of an island is tucked away in a quiet corner of Bacon, Sorsogon – the picturesque Paguriran Island. Paguriran is a tiny group of coral and rock islets located off the white sand beaches of Sawanga in Bacon. It is accessible from the adjacent beach by wading through crystal clear waters, the depth of which may range from ankle to waist depending on the tides. Within the island, coralline and granite crags enclose a shallow lagoon that is perfect for swimming (you have to watch out for sharp corals, though).
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/pag1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/pag2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/pag3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/pag4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/pag5.jfif" style="width:100%">
                        </div>
