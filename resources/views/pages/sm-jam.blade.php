        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>JAMBOREE LAKE</span></h2>

                    </div>
                    <div class="description">
                    Very little is known about the lake's origins, other than the presence of a small replica of the Statue of Liberty that once stood in the middle of the lake in the 1940s.
                    With the transfer of inmates from the Old Bilibid Prison (Bilibid Viejo or Cárcel y Presidio Correccional) in Santa Cruz, Manila to this new facility in 1941, the lands surrounding the lake served as the prison's food production area. Early inmates from the Cordillera Administrative Region helped develop the area by building terraces along the lake's shoreline reminiscent of the rice terraces in their native Ifugao.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/jam1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/jam2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/jam3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/jam4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/jam5.png" style="width:100%">
                        </div>
