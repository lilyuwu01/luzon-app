    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/camarines-norte"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BAGASBAS BEACH</span></h2>

                    </div>
                    <div class="description">
                        The mile-long stretch of Bagasbas Beach features sandy bottom and shallow waters which make it safe for surfers. The beach is known for its fine, gray sand with big waves.  What I like Bagasbas each, it's quiet and clean. Considering it's a public Beach, the local government was able to maintain the cleanliness of the beach.
                        Aside from surfing, you can enjoy here kiteboarding. This activity combines skills of surfing, snowboarding and wakeboarding with a flying kite. Bagasbas Beach is considered as one of the best kiteboarding spots in Asia. The best months to indulge kiteboarding is from November to March.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/baga1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/baga2.jpeg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/baga3.jpeg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/baga4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/baga5.jpg" style="width:100%">
                        </div>
