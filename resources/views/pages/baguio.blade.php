...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN BAGUIO</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/burnham.jpg" alt="Burnham Park" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Burnham Park</p>
                    <p class="desc1">Burnham Park is an open green park at the heart of Baguio. The park's lush greeneries and blooming flowers 
                        make you forget that you are in the middle of a highly urbanized city. Considered as the city's "mother of all parks," 
                        Burnham Park is one of Baguio's best attractions. It was named after urban planner Daniel Burnham, the American architect
                        who came up with the original design and layout of the park.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/burnham-park"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Camp John Hay</p>
                    <p class="desc2">The camp was a former rest and recreation facility for American soldiers. Today it has become one of the best
                        places to visit in Baguio over the years, mainly because it houses must-see tourist spots in one convenient area. Some might 
                        even consider it as the best tourist spot in Baguio City. This expansive recreational complex offers tourists tons of fun activities. 
                        It highlights the best that Baguio has to offer, which are pine trees, fresh air, cool breeze, and a serene atmosphere
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/camp-john-hay"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/camp.jpg" alt="Camp John Hay" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/mines.png" alt="Mines View Park" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mines View Park</p>
                    <p class="desc1">This park sits on a ridge on the northeast side of Baguio. Exploring the park is one of the recommended 
                        leisure activities in Baguio. As such, its main attraction is a viewing deck that offers a stunning view of the Cordillera 
                        Mountains and Benguet's old copper and gold mines. Tourists are given a chance to dress in traditional Ifugao garbs like bahag 
                        (loincloth), vests, and headdresses, and even hold a shield and spear for picture-taking.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/mines-view-park"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Strawberry Farm</p>
                    <p class="desc2">Visiting the strawberry farm in nearby La Trinidad along with other attractions is one of the top experiences 
                        you can't miss out on when you're in the Summer Capital. The weather in the North is perfect for growing several kinds of 
                        vegetables and fruits, but nothing is more popular and delicious than the plump red strawberries here. Strawberries are best
                        eaten when they're freshly harvested. So, grab a basket and pick the berries yourself.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/strawberry-farm"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/strawberry.jpg" alt="Strawberry Farm" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/tam-awan.jpg" alt="Tam-Awan Village" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Tam-Awan Village</p>
                    <p class="desc1">Built by the Chanum Foundation in 1998, Tam-Awan Village is modeled after native Ifugao villages to give 
                        people a glimpse of the other parts of the region. The word Tam-Awan in the local dialect means vantage point. An apt 
                        name since the Tam-Awan Village sits on a hillside with a panoramic view of the South China Sea. </p>
                    <button class="b5" style="vertical-align:middle"><a href="/tamawan-village"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/mount-province" class="previous round">&#8249;</a>
                            </div>
                    </div>
                </div>
            </div>
