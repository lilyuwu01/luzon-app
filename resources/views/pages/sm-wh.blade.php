        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>WHITE ISLAND</span></h2>

                    </div>
                    <div class="description">
                        White Island is one of the tourist spots in Occidental Mindoro. It is also called by the locals as Manadi Island which means “Sudden Appearance” for it is said to have suddenly appeared decades ago. It is a small island and an ideal destination for swimming, snorkeling, scuba diving and fishing. Some part of the shore are breeding grounds for turtles where they bury their eggs.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/wh1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/wh2.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/wh3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/wh4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/wh5.jpg" style="width:100%">
                        </div>
