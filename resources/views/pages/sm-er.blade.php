        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>ERMITA HILL</span></h2>

                    </div>
                    <div class="description">
                        It was on the 27th of December, 1735 a catastrophic tsunami hit and destroyed the old Baler’s main town. There were only six families survived. They ran and swam to the nearby Point Baja Hill which is now known as the Ermita Hill. The resettlement areas became known as “Kinagunasan” which literally means devastation. Survivors include the families of Bihasa, Bitong, Carrasco, Lumasac, Poblete and the prominent Angara family. At the bottom of the hill there are monuments that serves as a marker to those who have perished and survived the tragic destruction.
                        Ermita Hill is located in Poblacion, Casiguran. On top of the hill, you will see the scenic view of the entire Poblacion including the dark blue coast of the bay in Casiguran and other communities nearby.
                    </div>
                </div>
            </div>
