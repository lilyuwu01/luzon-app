        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BATAD AMPHITHEATER TERRACES</span></h2>

                    </div>
                    <div class="description">
                        The rice terraces here at Batad were originally built 2000 years ago and have stone walls, unlike others in the region that have mud walls. For centuries, farmers have worked these fields, using pretty much the same methods now as they did when they were first constructed.
                        It’s quite incredible to see the continuity in the farming practices over such a long period. And it’s amazing to think that something their ancestors built so long ago is still paying dividends now. An impressive inheritance for scores of generations.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bata1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bata2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bata3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bata4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bata5.jpg" style="width:100%">
                        </div>
