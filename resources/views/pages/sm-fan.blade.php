    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/batangas"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>FANTASY WORLD</span></h2>

                    </div>
                    <div class="description">
                        Fantasy World was initially intended to be a members-only club but was changed into a resort-theme park open to tourists coming from Metro Manila and Calabarzon. It received an endorsement from the Department of Tourism in 1997.
                        Land acquisition started in January 1999 while site development began in October with ECE Realty & Development Inc. as the project's initial developer.In 2001, it was granted pioneer incentives by the Board of Investments.
                        It was touted to be the "DisneyWorld of the Philippines" and was envisioned to dwarf Enchanted Kingdom.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/fan1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/fan2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/fan3.jpeg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/fan4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/fan5.jpeg" style="width:100%">
                        </div>
