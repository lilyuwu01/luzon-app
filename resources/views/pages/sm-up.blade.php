        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>UPSIDE DOWN MUSEUM</span></h2>

                    </div>
                    <div class="description">
                    Experience the world from another angle. Enter a topsy-turvy world when you explore the Upside Down Museum in the metro.
                    This interactive attraction will distort both your orientation and size as well as channel a “Stranger Things” type of afternoon.
                    As a tip, wear comfortable clothes and make sure to bring a powerbank or extra batteries for your devices. Enjoy a unique experience by heading to this fun and quirky space that’s located in Boom Na Boom Grounds in the Cultural Center of the Philippines along Roxas Boulevard in Manila.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/up1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/up2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/up3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/up4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/up5.jpg" style="width:100%">
                        </div>
