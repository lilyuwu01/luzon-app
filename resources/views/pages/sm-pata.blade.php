    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/ilocos"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>PATAPAT VIADUCT</span></h2>

                    </div>
                    <div class="description">
                        Patapat Viaduct, which is is elevated 31 meters over sea level was constructed by Hanil Development Co. Ltd. under the management of DPWH-PMO-PJHK and is maintained by the
                        Department of Public Works and Highways. The concrete bridge was completed and opened to the public in October 1986. Dubbed as the French Riviera of the Northern Philippines, 
                        the now famous Patapat Viaduct is attracting the attention not only of local tourists but foreign as well. The bridge conforms to the winding mountain side of the town’s coastal 
                        mountains primarily to solve the problem of landslide that have caused a number of vehicular accidents in the past.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/pat1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/pat2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/pat3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/pat4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/pat5.jpg" style="width:100%">
                        </div>
