    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/romblon"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>FOOTPRINTS BEACH</span></h2>

                    </div>
                    <div class="description">
                        A small, intimate and peaceful beach resort. It is surrounded by the tall coconut trees, rice fields, animals and beach and a friendly local community.  The beach is located at Agpudlos, San Andres.
                        Footprints beach resort offers affordable accommodation from air-con to fan bungalow and dormitory style right at the beach. They have also own little cosy beach bar and restaurant ready to serve you delicious shakes, drinks, appetizers, desserts and meals. Footprint is a 2 star resort.
                        They have different amenities such as: Free parking, Bicycle rental, free high speed internet (WiFi), Pets Allowed, Children Activities (Kid/Family Friendly).  You can also enjoy the different activities like, kayaking, snorkelling, sunset viewing and many more.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/foo1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/foo2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/foo3'[.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/foo4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/foo5.jpg" style="width:100%">
                        </div>
