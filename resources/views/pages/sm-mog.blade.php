        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MT. MOG-AO</span></h2>

                    </div>
                    <div class="description">
                        Considered as the most prominent peak in Besao, Mountain Province, this trail going to the mountain is a haven for mountaineers who experience hiking trails in Mountain Province. This location is just near the famous tourist spots like Mt. Pulag and Baguio City. It is also near Bontoc and Sagada where tourists always flock especially during summertime. 
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/mog1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/mog2.JPG" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/mog3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/mog4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/mog5.jpg" style="width:100%">
                        </div>
