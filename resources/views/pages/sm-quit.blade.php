        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>QUITINDAY GREEN HILLS FORMATION</span></h2>

                    </div>
                    <div class="description">
                        Quitinday Green Hills is a magnificent geological formation of mini-peaks located in Barangay Quitinday, Camalig, Albay, Philippines. This set of rolling hills is considered as one of the hidden natural wonder of Albay. The undulating terrain of Quitinday bear a resemblance to the famous Chocolate Hills attraction of Bohol but, in contrast, appears as verdant green hills because of lush vegetation. From the breezy hilltops one can vividly see the silhouette of majestic Mayon Volcano.
                        Quitinday Hills are thought to be a hidden geological treasure of the Albay since many locals do not know about it although those who travel to Legazpi City via plane are being welcomed by the hills’ amazing aerial view when their plane approaches the city’s domestic airport. If Chocolate Hills are named as such because of their chocolate look, the Quitinday Hills are being proposed to be called “pili nut hills” because of their pointed hilltops and the richness of pili nuts in the locality.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/quit1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/quit2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/quit3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/quit4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/quit5.jpg" style="width:100%">
                        </div>
