    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/camarines-sur"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MOUNT ISAROG</span></h2>

                    </div>
                    <div class="description">
                        Mount Isarog is an active stratovolcano located in the province of Camarines Sur, Philippines, on the island of Luzon. The mountain has active fumaroles and hot springs.
                        It has an elevation of 2,011 m (6,598 ft) above mean sea level. Mount Isarog was where local troops of the Philippine Army and Constabulary units and Bicolano guerrillas hid during the Japanese Occupation. In the 1970s, with the leadership of Romulo Jallores and his brother, they established the New People's Army in the Bicol region at the foot of this mountain.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/isa1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/isa2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/isa3.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/isa4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/isa5.jpg" style="width:100%">
                        </div>
