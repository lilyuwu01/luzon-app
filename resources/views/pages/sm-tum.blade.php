    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/kalinga"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>TUMUYOC FALLS</span></h2>

                    </div>
                    <div class="description">
                        Tumuyoc Falls is located in Pasil, Kalinga; needs to hike four hours from the nearest community. But, then again, nature's surprises will greet you all along. It measures around 30 feet high and cascades to a wide and very deep pool. The water is icy-cold and crystal clear. The pristine water also hosts endemic marine species such as small fishes, eels, and crabs. These are part of the common foods of the locals, cooked in indigenous ways.
                        And a few hours of walking, the Colayo Hot Spring could be a soothing place to rest and take a dip. And before the journey ends, trekkers will get to see the old American camp and the majestic and refreshing Tumuyoc Falls.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/tum1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/tum2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/tum3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/tum4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/tum5.webp" style="width:100%">
                        </div>
