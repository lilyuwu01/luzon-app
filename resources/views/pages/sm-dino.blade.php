    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/pampanga"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>DINOSAURS ISLAND PAMPANGA</span></h2>

                    </div>
                    <div class="description">
                        Go back to the Mesozoic Era and get up close and personal with Spinosaurus, Stegosaurus, Iguanodon, Triceratops and other species here at Dinosaurs Island where life-size animatronic dinosaurs come to life. This attraction started out as a business of exporting dinosaur mascots which then became Philippines’ first ever dinosaurs animatronics theme park.
                        Situated in a forest trail in Clark Freeport Zone, Dinosaur Island is a jungle vibe theme park that will take you to the kingdom of dinosaurs and insects. Enjoy two main attractions in this theme park: the Dinosaur Island and the Insectlandia with six sub-attractions for Dinosaur Island and three sub-attractions for the Insectlandia.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/dino1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/dino2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/dino3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/dino4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/dino5.jpg" style="width:100%">
                        </div>
