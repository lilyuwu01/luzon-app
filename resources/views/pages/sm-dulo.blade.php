    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/pateros"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>DULONG BAYAN MONUMENT</span></h2>

                    </div>
                    <div class="description">
                    The Dulong Bayan Monument depicts a historical site depicting the events of Philippine Revolution in 1896. Many people in Pateros resisted against the Spanish authorities. Among them were Guillermo Manalo and Eusebio Hermosa.
                    In their name, a monument was erected in Dulong Bayan, the place where they died defending the town. Every August 29, a celebration in their honor is always held, the monument being the center of the celebration. The monument can be seen at Bagong Calzada St. Brgy. Martinez, Pateros, Metro Manila.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/dulo1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/dulo2.jfif" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/dulo3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/dulo4.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/dulo5.jfif" style="width:100%">
                        </div>
