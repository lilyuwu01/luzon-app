    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/pasay"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>PHILIPPINE AIR FORCE AEROSPACE MUSEUM</span></h2>

                    </div>
                    <div class="description">
                    The history of the Philippine Air Force is enshrined in the Aerospace Museum located within the PAF Headquarters at Villamor Air Base. It first opened its doors on 2007 and remains the country’s only aviation museum.
                    It’s spacious enough to display various PAF aircrafts models and is a wonderful place to learn more about the country’s Air Force culture and history.
                    Revel in artifacts and relics that go as far back as the Second World War along with historic weapons, medals, suits, wing badges, and unit, to name a few.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/air1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/air2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/air3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/air4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/air5.JPG" style="width:100%">
                        </div>
