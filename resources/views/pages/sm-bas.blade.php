        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BASCO LIGHTHOUSE</span></h2>

                    </div>
                    <div class="description">
                        First lit in 2003, it was the first to be completed of the three. Basco Lighthouse was built in Naidi Hills, at the site of the old telegraph facility used during the American era and was destroyed by the Japanese during World War II.
                        The main column is round, white painted, and crowned with a red lantern room. The bottom portion and the attached dwelling (for the caretaker) are limestone masonry. The 20-meter tower has six stories, with the fifth being the gallery, 
                        allowing unobstructed views of the West Philippine Sea to the west, Mt. Iraya to the north, and the Basco Town Proper to the south. A nearby building houses the Bunker Cafe.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bas1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bas2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bas3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bas4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bas5.jpg" style="width:100%">
                        </div>
