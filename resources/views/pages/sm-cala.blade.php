        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>CALAGUAS ISLANDS</span></h2>
                    ...
                    <div class="description">
                        ...
                        Most of the islands are under the administrative jurisdiction of Vinzons, while the minor island of Maculabo is under the jurisdiction of the municipality of Paracale. Recently, the island of Tinaga, where the well-known long beach called Mahabang Buhangin
                        is located, is experiencing an influx of tourists despite the absence of accommodation. Campers and backpackers visit Mahabang Buhangin to experience its powdery white sands.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/calag1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/calag2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/calag3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/calag4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/calag5.jpg" style="width:100%">
                        </div>
