...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN PARANAQUE</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/sol.jpg" alt="Solaire Resort and Casino" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Solaire Resort and Casino</p>
                    <p class="desc1">Solaire Resort & Casino is an iconic structure known for its discreet luxury, and undeniable class and sophistication. Its modern design and silhouette brings together Manila's rich heritage and contemporary architecture that create the perfect canvas for the famous Manila Bay sunset to be put on display.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/solaire-resort-and-casino"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Redemptorist Church</p>
                    <p class="desc2">The National Shrine of Our Mother of Perpetual Help  also known as the Redemptorist Church and colloquially as Baclaran Church, is a prominent national shrine dedicated to Our Lady of Perpetual Help along Roxas Boulevard in Baclaran, Parañaque city of Metro Manila, Philippines.
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/redemptorist-church"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/red.jpg" alt="Redemptorist Church" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/dre.webp" alt="City of Dreams Manila" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">City of Dreams Manila</p>
                    <p class="desc1">City of Dreams Manila is a 6.2-hectare (15-acre) luxury integrated resort and casino complex located on the Entertainment City gaming strip at Asean Avenue and Roxas Boulevard in Parañaque, Metro Manila, Philippines.
                    </p>
                    <button class="b3" style="vertical-align:middle"><a href="/city-of-dreams-manila"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Ayala Malls Manila Bay</p>
                    <p class="desc2">Ayala Malls Manila Bay (formerly Ayala Malls Bay Area) is a shopping mall in Metro Manila, the Philippines developed by Ayala Land Inc. under the Ayala Malls brand. Opened on September 26, 2019, it is the first Ayala Mall in Parañaque. It is located in the Aseana City township development, close to PAGCOR's Entertainment City and archrival mall SM Mall of Asia in Bay City.
                    </p>
                    <button class="b4" style="vertical-align:middle"><a href="/the-ayala-malls-manila-bay"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/bay.jpg" alt="Ayala Malls Manila Bay" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/oka.jpg" alt="Okada Manila Resort and Casino" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Okada Manila Resort and Casino</p>
                    <p class="desc1">Okada Manila  is a casino resort and hotel complex located on the Entertainment City gaming strip in Parañaque, Metro Manila, Philippines. In 2007, with a total construction cost of about 250 billion Yen and spending 7 years, Japanese billionaire Kazuo Okada established and managed Okada Manila.
                    </p>
                    <button class="b5" style="vertical-align:middle"><a href="/okada-manila-resort-and-casino"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/navotas" class="previous round">&#8249;</a>
                                <a href="/pasay" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
