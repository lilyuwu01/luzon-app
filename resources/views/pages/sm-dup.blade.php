    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/apayao"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>DUPAG ROCK FORMATION</span></h2>

                    </div>
                    <div class="description">
                        This is Dupag Rock formation located in Marag Valley, Luna, Apayao, Philippines. If you are just looking down its just like an ordinary rock but if you will see the aerial view its will amaze you on how it looks. Its like alien structure made or house of superman.
                        Its very dangerous for not expert. The way going is not that easy, the place is very far and you need to cross the big flowing river where the normal water is until the knee and passed to a small forest then you can reach the foot of the rock formation. 
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/dup1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/dup2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/dup3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/dup4.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/dup5.jpg" style="width:100%">
                        </div>
