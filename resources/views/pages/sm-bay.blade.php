    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/paranaque"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>THE AYALA MALLS MANILA BAY</span></h2>

                    </div>
                    <div class="description">
                    The mall features a 1-hectare Central Garden and ten digital cinemas, the biggest among Ayala Malls, including an A-Giant Screen cinema & A-Luxe Recliner Seats for select cinemas.
                    The mall also hosts multiple entertainment and leisure facilities including the largest Timezone branch in the country, at 2,000 square meters.
                    Ayala Malls Manila Bay has four dedicated country-specific shopping sections, the Filipino Village, China Town, Japan Town and Korea Town.
                    It will be anchored by The Landmark Department Store and Supermarket, opening on 2023.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bay1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/dre2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bay3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bay4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bay5.jpg" style="width:100%">
                        </div>
