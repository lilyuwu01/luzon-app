        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>SM MALL OF ASIA</span></h2>

                    </div>
                    <div class="description">
                    Owned and developed by SM Prime Holdings, the largest mall chain owner and developer in the Philippines, it has a land area of 67 hectares (170 acres), a gross floor area of approximately 489,891 m2 (5,273,140 sq ft),
                    and offers 46,647 m2 (502,100 sq ft) of floor area space for conventions and social functions. The area attracts a daily average foot traffic of about 200,000 people.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/asia1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/asia2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/asia3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/asia4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/asia5.jpg" style="width:100%">
                        </div>
