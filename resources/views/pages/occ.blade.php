...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN OCCIDENTAL MINDORO</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/apo.webp" alt="Apo Reef Natural Park" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Apo Reef Natural Park</p>
                    <p class="desc1">Apo Reef, located in Sablayan, Occidental Mindoro is one of the best tourist spots not only in Occidental Mindoro 
                        but in the whole country. The reef is recognized as the second-largest contiguous reef system second only to the Great Barrier 
                        Reef in Australia.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/apo-reef-natural-park"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">White Island</p>
                    <p class="desc2">Also known as  “Manadi Island” which translates to “Sudden Disappearance,” White Island is the best tourist spot for 
                        the mystery lovers. According to the rumors, the island suddenly disappeared a long time ago, and then it re-appeared again. White 
                        Island is a small beach island that has creamy-white sands. It is an ecological sanctuary teeming with rich marine resources like 
                        fish and turtles.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/white-island"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/white.jpg" alt="White Island" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/raga.jpg" alt="Ragara Beach" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Ragara Beach</p>
                    <p class="desc1">Ragara beach resort is a gem to find in the small town of Calintaan, Occidental Mindoro. 
                        It is one of the most highly-ranked resorts in the province. One traveler reviewed it as “similar feels 
                        as Boracay, but less crowded”. It has a beautiful sunset view and a serene environment. If you want to 
                        escape the noise of the city, this is definitely the place for you to visit.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/ragara-beach"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Pandan Island</p>
                    <p class="desc2">Pandan Island Resort is one of the best tourist spots in Occidental Mindoro and tourists keep 
                        coming back to this simple and beautiful island. Aside from a stretch of white sand beach good for swimming 
                        and coral gardens perfect for snorkeling, visitors love this place because it is a peaceful, relaxing and 
                        friendly paradise.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/pandan-island"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/pan.webp" alt="Pandan Island" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/ig.jpg" alt="Mount Iglit-Baco National Park" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mount Iglit-Baco National Park</p>
                    <p class="desc1">Mount Iglit-Baco National Park. It is a protected area surrounding the Mount Iglit and Mount 
                        Baco located in the central interior of Mindoro. The park is the habitat of the endemic Tamaraw in the Philippines, 
                        it is currently one of the most seriously endangered animals in the world and for that very reason, this park was established.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/mt-iglit-baco-national-park"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/mimaropa" class="previous round">&#8249;</a>
                                <a href="/oriental-mindoro" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
