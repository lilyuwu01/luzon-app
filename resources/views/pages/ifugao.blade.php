...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN IFUGAO</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/tappiyah.webp" alt="Tappiyah Falls" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Tappiyah Falls</p>
                    <p class="desc1">Tappiyah falls is one of the famous tourist spots in Banaue, Ifugao. It cascades on the face of a massive rock cliff for more than 75 meters. 
                        Because of its sheer water volume and force, it created a wide and deep pool with churning waters. Its waters are cold and crystal-clear, emanating from 
                        the mossy forests of Mt. Amuyao and its adjacent ridges.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/tappiyah-falls"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Batad Amphitheater Terraces</p>
                    <p class="desc2">Batad Rice Terraces is known for its breathtaking view that resembles the shape of a huge amphitheater. One could just wonder how the Ifugao’s 
                        ancestors build these majestic masterpieces using wooden tools and stones. The rice terraces are not merely a showcase for tourism but are lasting testimonies 
                        of the ancient engineering skills of the people.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/batad-amphitheater-terraces"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/batad.webp" alt="Batad Amphitheater Terraces" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/napulawan.webp" alt="Mt. Napulawan" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mt. Napulawan</p>
                    <p class="desc1">Mt. Napulawan is derived from the Ifugao term, “Tuwale,” which literally means, white. Perhaps, this is because of the cloud and fog which perpetually cover the mountain. 
                        Locals also say that Bibiyo (a fairy) guard the mountain. The summit of Mt. Napulawan offers breathtaking sights of Ifugao and the adjacent mountain ranges. Mt. Tabayoc, Mt. Pulag, and 
                        Mt. Amuyao are visible from here. Occasionally, a stunning sea of cloud formations appear. Today, it is one of the most frequented Ifugao tourist spots.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/mt-napulawan"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Kiangan Shrine</p>
                    <p class="desc2">Kiangan Shrine is one of the historical Ifugao tourist spots. It signifies the locals” valiant resistance against the Japanese invaders. 
                        In fact, this is where Gen. Yamashita and his troops informally surrendered, thus, officially ending World War II in the Philippines. A museum is also 
                        built within the shrine’s compound. This showcases the rich culture and traditions of the locals.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/kiagan-shrine"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/shrine.webp" alt="Kiangan Shrine" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/nagacadan.webp" alt="Nagacadan Rice Terraces" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Nagacadan Rice Terraces</p>
                    <p class="desc1">These terraces are less popular but such that should make up to your bucket list. 
                        They are nonetheless, among the most preserved in Ifugao, away from the damaging impacts of mass tourism. 
                        Interestingly, these terraces portray the intimate connection of the locals to their forests. In fact, the 
                        Muyung system still plays an integral role. Muyung is an indigenous forest conservation system.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/nagacadan-rice-terraces"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/benguet" class="previous round">&#8249;</a>
                                <a href="/kalinga" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
