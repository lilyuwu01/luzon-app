...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN PATEROS</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/dulo.jpg" alt="Dulong Bayan Monument" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Dulong Bayan Monument</p>
                    <p class="desc1">The historical landmark was created in memory of many people in Pateros resisted against the Spanish authorities. Among them were Guillermo Manalo and Eusebio Hermosa. The monument is the place where they died defending their town and a site depicting the events of Philippine Revolution in 1896. Every August 29, a celebration in their honor is always held, the monument being the center of the celebration.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/dulong-bayan-monument"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">San Roque Church</p>
                    <p class="desc2">
                    The church was built in 1815 having San Roque as the patron. It has a high tower on the right side where the church bells are situated. The interior of the church is well-furnished with new benches, chandeliers, and a well-planned simple altar. Its architecture is simple both inside and outside
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/san-roque-church"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/mang.jpg" alt="San Roque Church" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/mem.jpg" alt="Garden Of Memories" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Garden Of Memories</p>
                    <p class="desc1">A private cemetery which serve as park for the residents of Pateros, Taguig, Pasig, Makati and other nearby towns.
                    </p>
                    <button class="b3" style="vertical-align:middle"><a href="/garden-of-memories"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/pasig" class="previous round">&#8249;</a>
