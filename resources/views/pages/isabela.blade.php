...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <p class="footer-class">TOURIST SPOTS IN ISABELA</p>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/agui.jpg" alt="Gen. Aguinaldo Shrine" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Gen. Aguinaldo Shrine</p>
                    <p class="desc1">The shrine commemorates the capture of Gen. Emilio Aguinaldo by the invading American forces on March 23, 1901, 
                        making it one of the historical tourist spots in Isabela. It is in this province where the general surrendered to the Americans, 
                        ending the Filipino-American War. The shrine also offers a breathtaking view of the surrounding landscapes of mountains and verdant 
                        rice fields. It’s an ideal spot for unwinding and relishing the surrounding sights</p>
                    <button class="b1" style="vertical-align:middle"><a href="/gen-aguinaldo-shrine"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Bonsai Forest</p>
                    <p class="desc2">One of the most pristine tourist spots in Isabela, the Bonsai Forest is an enchanting beauty to behold. It covers more than 5000 hectares with plants ranging from one foot to 7 feet. 
                        You’ll literally feel like a giant as you walk through this bizarre ecosystem. 
                        ...
                        It is one of the most pristine Isabela tourist attractions.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/bonsai-forest"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/bonsai.jpg" alt="bonsai" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/dicot.webp" alt="Dicotcotan Beach" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Dicotcotan Beach</p>
                    <p class="desc1">Dicotcotan beach features a three-kilometer long of pristine beach. It is a perfect getaway for those who prefer less touristy destinations.
                        ...
                        Because the beach lies on a remote destination, few tourists and locals come here.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/dicotcotan-beach"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">San Matias Parish Church</p>
                    <p class="desc2">The San Matias Parish Church, commonly known as Tumauini Church, is a Roman Catholic church in the municipality of Tumauini, Isabela, Philippines, 
                        within the jurisdiction of the Roman Catholic Diocese of Ilagan. It became a separate parish independent from Cabagan under the advocacy of Saint Matthias in 1751.
                        The church, known for its brick, Baroque-style architecture, was declared a National Cultural Treasure by the National Museum of the Philippines. </p>
                    <button class="b4" style="vertical-align:middle"><a href="/san-matias-parish-church"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/san matias.jpg" alt="San Matias Parish Church" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/blue.webp" alt="Blue Lagoon" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Blue Lagoon</p>
                    <p class="desc1">The Blue Lagoon is one of the emerging tourist spots in Isabela. This lake with its inviting waters reflect the blue sky. Boating and swimming are favorite activities here. 
                        Jump towards the pool and have a soul-relieving experience.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/blue-lagoon"><span> See More</span></a></button>

                    <div class="see-more">
                            <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                                <div class="next-page">
                                    <a href="/cagayan-province" class="previous round">&#8249;</a>
                                    <a href="/nueva-vizcaya" class="next round">&#8250;</a>
                                </div>
                    </div>
                </div>
            </div>
