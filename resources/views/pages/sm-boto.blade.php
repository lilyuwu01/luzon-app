        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>BOTONG TWIN FALLS</span></h2>

                    </div>
                    <div class="description">
                        Located at Osiao, Bacon District. They called it twin falls because they are closed to each other, but they’re actually  two different falls with two different colours of water. Thats the reason why they called it “BLUE & GREEN FALLS”. Because the water of the first falls is almost green while the the second falls is almost blue. To find out more visit the Botong Twin Falls, with your family and friends and don’t forget to coordinate with the PNOC-BACMAN Geothermal Plant Mgmt.(maintaining the area).
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/boto1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/boto2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/boto3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/boto4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/boto5.jfif" style="width:100%">
                        </div>
