    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/tarlac"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>ANZAP TWIN FALLS</span></h2>

                    </div>
                    <div class="description">
                        Anzap Twin falls is one of the most tourist spots in Tarlac. It is located at Barangay Bigbiga, Mayantoc. It is 200 feet waterfalls which the volume of the water varies depending on the season. The area is surrounded by lush greenery and founders. Most of the trips going to the falls may require overnight camping for beginners. The journey is not that difficult and you'll pass through a river and few challenging trails. Some sites give a beautiful view of the river and mountains which are good resting spots.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/anz1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/anz2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/anz3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/anz4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/anz5.jpg" style="width:100%">
                        </div>
