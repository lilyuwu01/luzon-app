...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN QUEZON</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/balesin.webp" alt="Balesin Island" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Balesin Island</p>
                    <p class="desc1">Balesin Island is one of the best tourist spots in Quezon Province, a 500-hectare island paradise with a 
                        7.3 kilometers long stretch of pristine white sand beaches. The island is considered as one of the most luxurious island 
                        resort in the Philippines open only for its members</p>
                    <button class="b1" style="vertical-align:middle"><a href="/balesin-island"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Salibungot Beach</p>
                    <p class="desc2">Salibungot Beach is one of the most visited places in Quezon Province, a very unusual yet beautiful beach. 
                        There are hundreds of popular beaches in the Philippines, white sand, pink sand, grey sand beaches but this one is a unique 
                        golden sand beach! It is a very long stretch of unspoiled golden sand beach with beautiful turquoise sea water. 
                        The coastline is dotted with pine trees and during low tide, a long sandbar will appear</p>
                    <button class="b2" style="vertical-align:middle"><a href="/salibungot-beach"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/sali.webp" alt="Salibungot Beach" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/kana.webp" alt="Kanaway Beach" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Kanaway Beach</p>
                    <p class="desc1">Kanaway Beach is one of the tourist spots in Quezon Province, famous for its vast and long stretch of golden sand beach. 
                        Kanaway Beach is located in the same island as Salibungot Beach is that’s why it shares the same golden sand. The golden sand could extend 
                        approximately 400 meters from the shore that one could cross the nearby islets barefoot during low tide. </p>
                    <button class="b3" style="vertical-align:middle"><a href="/kanaway-beach"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Kamay ni Hesus Shrine</p>
                    <p class="desc2">Kamay ni Hesus Shrine, a popular pilgrimage destination in Luzon. People who needs to pray for healing come to Kamay ni Hesus Chruch to attend 
                        the healing mass. At the top of the hill stands a 50-feet statue of Ascending Jesus Christ which also gives a bird-eye view of the place. It would need around 
                        300+ steps to reach the top. One can also see other statues and replicas mentioned in the Bible like the Noah’s Ark, Adam and Eve, Garden of Even, The Last Supper 
                        and more.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/kamay-ni-hesus-shrine"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/kam.webp" alt="Kamay ni Hesus Shrine" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/banahaw.webp" alt="Mount Banahaw" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mount Banahaw</p>
                    <p class="desc1">Mount Banahaw is an active volcano in Quezon Province which is popular among local pilgrims and mountain climbers. It is the highest peak in 
                        CALABARZON Region with an elevation of 7,120 feet above the ground covering 10,901 hectares of land.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/mt-banahaw"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/rizal" class="previous round">&#8249;</a>
                            </div>
                    </div>
                </div>
            </div>
