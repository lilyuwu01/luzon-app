...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN PASAY</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/up.webp" alt="Upside Down Museum" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Upside Down Museum</p>
                    <p class="desc1">Upside Down Museum is the newest craze in Mega Manila /Philippines. It features a massive upside down house - complete from Living room, dining,kitchen,bedroom,office and bathroom. It also features a real steel bridge with real SUVs(cars) - all upside down. It also features illusions that are never before seen in the Philippines. The challenge is to do crazy poses for a photokeeper.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/upside-down-museum"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Philippine Air Force Aerospace Museum</p>
                    <p class="desc2">The Philippine Air Force Aerospace Museum is an aerospace museum located within the premises of Colonel Jesus Villamor Air Base in Pasay, Philippines.
                    The museum was founded as the Marcos Museum in 2 May 1974.[2] The museum at its current location opened in June 2007.
                    </p>
                    <button class="b2" style="vertical-align:middle"><a href="/philippine-air-force-aerospace-museum"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/air.jpg" alt="Philippine Air Force Aerospace Museum" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/asia.jpg" alt="SM Mall of Asia" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">SM Mall of Asia</p>
                    <p class="desc1">SM Mall of Asia, also abbreviated as SM MoA, or simply Mall of Asia or MoA, is a large shopping mall in the Philippines, located at Bay City, Pasay, Philippines, within the SM Central Business Park, a reclaimed area within Manila Bay, and the southern end of Epifanio de los Santos Avenue (EDSA).
                    </p>
                    <button class="b3" style="vertical-align:middle"><a href="/sm-mall-of-asia"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">The Dessert Museum</p>
                    <p class="desc2">The Dessert Museum, an interactive exhibit based around the sweet stuff, can also be found in Pasay City. Here, you can find 8 intricately designed and curated experiences built around a specific sweet treat. Each dessert-themed room is aimed at delighting the senses. What’s more, you get to try a signature creation after every room. Be sure to save some room for dessert. 
                    </p>
                    <button class="b4" style="vertical-align:middle"><a href="/the-dessert-museum"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/des.jpg" alt="The Dessert Museum" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/new.jpg" alt="Newport Mall" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Newport Mall</p>
                    <p class="desc1">For a more upscale experience, head over to Newport Mall. A project of the Megaworld Corporation, Newport Mall is connected to Resorts World Manila, a world-class hotel, resort, and casino. Within the Newport property, you will find various retail stores that offer world-renowned brands such as Zara, Gucci, and Nike. The mall also boasts over 50 dining and shopping options as well as a 24-hour cinema, and a world-class theater. 
                    </p>
                    <button class="b5" style="vertical-align:middle"><a href="/newport-mall'"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/paranaque" class="previous round">&#8249;</a>
                                <a href="/pasig" class="next round">&#8250;</a>
                            </div>
                    </div>
                </div>
            </div>
