    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/calabarzon"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>GEN. EMILIO AGUINALDO SHRINE</span></h2>

                    </div>
                    <div class="description">
                        This historical house witnessed the first proclamation of Philippine Indepence in June 12, 1898.  Built in 1845, it is the ancestral home of Emilio Aguinaldo, first president of the Philippines.
                        The ground floor was converted into a museum displaying Aguinaldo's memorabilia and historical artifacts. Aguinaldo's tomb is in the garden.
                        A number of controversies hounded Aguinaldo in his lifetime, among which were his order to execute Katipunan founder Andres Bonifacio in 1897 and his involvement with the assassination of General Antonio Luna in 1899. Luna was rising in prominence at the time and was perceived as his rival in military capability. 
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/em1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/em2.png" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/em3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/em4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/em5.jpg" style="width:100%">
                        </div>
