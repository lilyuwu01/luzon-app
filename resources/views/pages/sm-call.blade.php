        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>CALLE CRISOLOGO</span></h2>

                    </div>
                    <div class="description">
                        Calle Crisologo is known for its cobblestone pavements and old Spanish structures.  These structures used to be houses of wealthy families during the Spanish 
                        colonial period but several were destroyed by fire during the Japanese occupation of the Philippines.  The burned houses were later on reconstructed and have 
                        been converted into inns, cafes, and shops selling items such as accessories, furniture, antiques, and other souvenir items. Before it became Calle Crisologo 
                        in the 1900s, this historic street was called by various names – Calle Escolta de Vigan in 1the 500s during the Spanish period, Kasanglayan, and Washington Street 
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/call1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/call2.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/call3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/call4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/call5.jpg" style="width:100%">
                        </div>
