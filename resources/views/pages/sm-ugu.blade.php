    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/nueva-vizcaya"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MT. UGU</span></h2>

                    </div>
                    <div class="description">
                        Mt. Ugo came from “Ugoan” which is an Ibaloi word that means “to cut the neck”. It was said that the mountain was named as such due to the oral tradition that Mt. Ugo is the place where the invading Spaniards were killed. In spite of a somewhat violent etymology, Mt. Ugo can be seen as a monument to the fierce determination of its locals to defend their way of life.
                        Mt. Ugo was discovered in the year 1987 in the aftermath of a Philippine Airlines aircraft crash on one of Mt. Ugo’s slopes. Rescuers, including mountaineers and locals, found the wreckage of the plane 200 yards just below the summit. From the date of its discovery, many mountaineers have gone to explore the trail of the mountains.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ugu1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ugu2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ugu3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ugu4.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ugu5.JPG" style="width:100%">
                        </div>
