        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>TANGADAN FALLS</span></h2>
                    ...
                    <div class="description">
                        ...
                        Tangadan Falls came from the Tagalog word “Tangad” which means “looking up”. If you are a nature lover and adventurous person you don’t want to miss swimming and looking up in these gorgeous falls. Also, it becomes a favorite attraction for swimming, cliff diving, and cliff jumping. There’s actually a 15 to 20 feet high rocky spot where tourists can do cliff diving.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/tan1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/tan2.jpeg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/tan3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/tan4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/tan5.jpg" style="width:100%">
                        </div>
