    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/quirino"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LANDINGAN VIEWPOINT</span></h2>

                    </div>
                    <div class="description">
                        It was called Landingan because there was a Tora-Tora airplane runway back then for the missionaries who went on missions to the Bugkalot in the ancient days. The Landingan Circuit has a total trail length of 13 kilometers. According to its past history, Landingan Viewpoint was opened to the public in the year 2019.
                        Because of its gaining popularity in the year 2019 by means of all social media platforms such as Facebook, Instagram, and YouTube, it got featured on TV Patrol news, and in the following months, thousands of tourists visited this amazing place. Succeedingly in the year 2020, Miss Earth together with Miss Supranational and Miss Asia Pacific representatives visited the flower garden and planted a great mixture of plants as part of their activity.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/lan1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/lan2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/lan3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/lan4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/lan5.jpg" style="width:100%">
                        </div>
