        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>TONDAL BEACH</span></h2>

                    </div>
                    <div class="description">
                        Tondol White Sand Beach is located at the northern tip of Anda, an island municipality that used to be accessible only by boat across the narrow Catubig Channel. In the early 1990s, a bridge across the channel was constructed to connect the island to Brgy. Tara, Bolinao, Pangasinan.
                        It became a favorite among tourists because of the long shallow nature of the beach. Tanduyong Island is almost a kilometer away which can be reached on foot during low tide. It’s best to visit Tondol Beach during the summer or dry months and most especially during low tide for you to 
                        experience and enjoy the beauty of the beach.
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/ton1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/ton2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/ton3.webp" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/ton4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/ton5.jpg" style="width:100%">
                        </div>
