    ...
    <body>
        <div class="wrapper">
           <header>
            ...
            <div class="back">
                <div class="back1">
                    <a href="/quezon"><svg class="bb" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" viewBox="0 0 512 512" width="1.5em" height="1.5em">
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MOUNT BANAHAW</span></h2>

                    </div>
                    <div class="description">
                        As the largest mountain in this part of Luzon, Banahaw is revered as a sacred mountain with the land surrounding it considered to be holy land by the Tagalog people living in its vicinity.  Sacred mountains and holy lands attract no small number of religious pilgrims.  Large mountains also attract large numbers of climbers.  The two groups keep local businesses very happy and busy.
                        As a spiritual mountain, Mount Banahaw is said to be a source of psychic energy, with numerous reported miraculous physical and spiritual healings.  As such it attracts a variety of mystics, psychics, faith healers, hermits, religious pilgrims and cults.  Religious visitors are said to commune with mountain spirits.  Apparently, the mountain also has a number of caves which are inhabited from time to time by religious hermits.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/bana1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/bana2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/bana3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/bana4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/bana5.jpg" style="width:100%">
                        </div>
