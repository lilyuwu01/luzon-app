        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>TAPUAKAN RIVER</span></h2>

                    </div>
                    <div class="description">
                        The Tapuacan River, also known as Tapuakan River or Pugo River, is a river located in Barangay Cares, municipality of Pugo, La Union, Philippines. 
                        Its headwaters are situated at the Santo Tomas mountain range, with the main tributary being the Najeng River located in Barangay Tabaan Norte, Tuba, Benguet. 
                        ...
                        In Ilocano, tapuakan means "a place where one can jump as high". In the river, cool and pristine water flows from the town's streams amid a huge rockbeds or large rock formations surrounded 
                        by forests and a waterfall. 
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/tap1.jfif" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/tap2.jfif" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/tap3.jfif" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/tap4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/tap5.jpg" style="width:100%">
                        </div>
