        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>MONASTERIO DE TARLAC</span></h2>
                    ...
                    <div class="description">
                        ...
                        The congregation has a total population of thirty (30) Fraters all over the country - all destined to a life of monasticism and contemplative life. The rather solitary and prayerful life in the monastery took an unexpected turn when it became the fitting shrine of the authentic relic or fragment of the True Cross upon which Jesus Christ was crucified and died in Golgotha, according to Christian tradition.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/mon1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/mon2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/mon3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/mon4.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/mon5.jpg" style="width:100%">
                        </div>
