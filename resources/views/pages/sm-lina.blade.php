        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>LINAO NI VICTO</span></h2>

                    </div>
                    <div class="description">
                        This unrated waterfall is often out of the bucket list of tourists visiting Romblon in Tablas Island.
                        While locals and a few tourists know the place, finding the exact location in Google maps is unavailable.
                        Linao ni Victo falls pins down to Barangay Panique in Odiongan, nearing the boundary to San Andres town. Pass by the provincial road and turn to Tabing Ilog Road until you reach small signage pointing to the falls.
                        The fall is relatively small in terms of drop, but the basin catches tourists’ attention. As calm as a bluish swimming pool! Rocky walls envelop the natural pool with varying heights, acting as a diving platform for the thrill-seekers.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/lina1.webp" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/lina2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/lina3.png" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/lina4.png" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/lina5.png" style="width:100%">
                        </div>
