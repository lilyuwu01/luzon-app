        ...
        <div class="wrapper">
           <header>
            ...
            <div class="about">
                ...
                <div class="history">
                    <div class="title">
                        <h2> ABOUT <span>SHANGRI-LA PLAZA MALL</span></h2>
                    ...
                    <div class="description">
                        ...
                        Shangri-La Plaza is located along Shaw Boulevard corner Epifanio de los Santos Avenue, Barangay Wack-Wack Greenhills, Mandaluyong. It is adjacent and directly connected to other Shangri-La properties, Edsa Shangri-La, Manila, The St. Francis Shangri-La Place and One Shangri-La Place. It is also near other shopping centers namely, SM Megamall and Starmall EDSA-Shaw.
                    </div>
                </div>
            </div>
                ...
                <div class="view">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides fade">
                          ...
                          <img src="images/sha1.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">2 / 5</div>
                          <img src="images/sha2.jpg" style="width:100%">
                        </div>
                        
                        <div class="mySlides fade">
                          <div class="numbertext">3 / 5</div>
                          <img src="images/sha3.jpg" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">4 / 5</div>
                            <img src="images/sha4.png" style="width:100%">
                        </div>

                        <div class="mySlides fade">
                            <div class="numbertext">5 / 5</div>
                            <img src="images/sha5.jpg" style="width:100%">
                        </div>
