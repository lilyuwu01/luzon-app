...
<html lang="en">
    ...
    <body>
        ...
        <div class="footer">
            <div class="footer-class">TOURIST SPOTS IN ROMBLON</div>
        </div>

        <div class="container">
            <div class="feature1">
                <div class="pic">
                    <img src="images/binu.webp" alt="Binucot Beach" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Binucot Beach</p>
                    <p class="desc1">Binucot beach in Ferrol. Located in between Looc and Odiongan, you can reach this beach in 30 minutes either way around.
                        Expect those dramatic sunset views during the late afternoon visit. Thanks to its long stretch of white sand coastline, tourists will 
                        likewise love the tropical vibe and views as well.</p>
                    <button class="b1" style="vertical-align:middle"><a href="/binucot-beach"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Footprints Beach</p>
                    <p class="desc2">Footprints beach is one of the famous beaches in Romblon to visit whenever you’re touring Tablas Island.
                        While Footprints beach resort lies on the coast of San Andres, it is one of the faraway resorts from the port and airport.
                        Needless to say, it stays true when you want to experience simple island life in Romblon, even for just a couple of days.
                        Guests can likewise enjoy the peaceful sunsets in the Footprints beach resort, in addition to the calmer waves of the western coast.</p>
                    <button class="b2" style="vertical-align:middle"><a href="/footprints-beach"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/foot.webp" alt="Footprints Beach" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/linao.webp" alt="Linao Ni Victo" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Linao Ni Victo</p>
                    <p class="desc1">This unrated waterfall is often out of the bucket list of tourists visiting Romblon in Tablas Island.
                        Linao ni Victo falls pins down to Barangay Panique in Odiongan, nearing the boundary to San Andres town. Pass by the 
                        provincial road and turn to Tabing Ilog Road until you reach small signage pointing to the falls.</p>
                    <button class="b3" style="vertical-align:middle"><a href="/linao-ni-victo"><span> See More</span></a></button>
                </div>
            </div>

            <div class="feature1">
                <div class="paoay">
                    <p class="title2">Saint Joseph Cathedral</p>
                    <p class="desc2">Saint Joseph Cathedral in Romblon Island is also one of the oldest structures built sometime in the 15th century.
                        As one of the National Cultural Treasure of the Philippines in Romblon, the Saint Joseph Cathedral is also the center of Catholicism 
                        in the Romblon province. Its well-maintained architecture features coral stone construction to its facade, walls, and buttresses. You 
                        cannot also ignore its bell tower adorned with red bricks.</p>
                    <button class="b4" style="vertical-align:middle"><a href="/saint-joseph-cathedral"><span> See More</span></a></button>
                </div>
                <div class="pic">
                    <img src="images/jo.webp" alt="Saint Joseph Cathedral" class="image">
                </div>
            </div>

            <div class="feature1">
                <div class="pic">
                    <img src="images/guiting.webp" alt="Mount Guiting Guiting" class="image">
                </div>
                <div class="paoay">
                    <p class="title1">Mount Guiting Guiting</p>
                    <p class="desc1">Those looking for an extra adventure for their Romblon tourist spots adventure may take the challenge 
                        to climb Mount Guiting Guiting in San Fernando town. With an elevation of 2,058 meters above sea level, this marks 
                        the highest point in Romblon. The ideal itinerary for climbing Mount Guiting Guiting is three days minimum to maximize 
                        your climbing adventure in Sibuyan Island.</p>
                    <button class="b5" style="vertical-align:middle"><a href="/mt-guiting-guiting"><span> See More</span></a></button>

                    <div class="see-more">
                        <button class="button" id="myBtn" style="vertical-align:middle"><span>Choose another Region</span></button>
                            <div class="next-page">
                                <a href="/palawan" class="previous round">&#8249;</a>
                            </div>
                    </div>
                </div>
            </div>
